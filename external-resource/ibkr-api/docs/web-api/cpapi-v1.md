...
*   [Introduction](./cpapi-v1.md#introduction)
    
*   [Requirements & Limitations](./cpapi-v1.md#api-req)
    *   [Canadian Residents Restricted From Programmatically Trading Canadian Products](./cpapi-v1.md#canadian-trading)
        
*   [WebAPI Basics Tutorial](./cpapi-v1.md#cp-tutorial)
    
*   [Client Portal Gateway](./cpapi-v1.md#cpgw)
    *   [Limitations of the Client Portal Gateway](./cpapi-v1.md#gw-limitations)
        
    *   [How to Download And Run The Gateway](./cpapi-v1.md#how-to-gateway)
        *   [Download and install the Java Runtime Environment](./cpapi-v1.md#download-java)
            
        *   [Download and unzip the Client Portal API Gateway](./cpapi-v1.md#gw-step-one)
            
        *   [Run the API Gateway](./cpapi-v1.md#run-gw)
            
    *   [How To Modify The Client Portal Gateway Port](./cpapi-v1.md#modify-port)
        
    *   [Client Portal Gateway FAQ](./cpapi-v1.md#cpgw-faq)
        
*   [Authentication](./cpapi-v1.md#authentication)
    *   [Session Authentication](./cpapi-v1.md#session-auth)
        
    *   [Background regarding CP Web API sessions:](./cpapi-v1.md#auth-sessions-background)
        
    *   [Understanding Brokerage Sessions](./cpapi-v1.md#auth-sessions-brokerage)
        
    *   [Understanding Interactive Brokers terminology](./cpapi-v1.md#auth-sessions-terminology)
        
    *   [Managing Multiple Sessions](./cpapi-v1.md#multi-session)
        
    *   [Using a Paper Account](./cpapi-v1.md#paper-auth)
        
    *   [Authentication Frequently Asked Questions](./cpapi-v1.md#auth-faq)
        
*   [Pacing Limitations](./cpapi-v1.md#pacing-limitations)
    
*   [Regular Server Maintenance](./cpapi-v1.md#cpapi-server-maint)
    
*   [Endpoints](./cpapi-v1.md#endpoints)
    *   [Alerts](./cpapi-v1.md#alerts)
        *   [Create or Modify Alert](./cpapi-v1.md#create-alert)
            
        *   [Get a list of available alerts](./cpapi-v1.md#get-alert-list)
            
        *   [Get details of a specific alert](./cpapi-v1.md#get-alert)
            
        *   [Get MTA Alert](./cpapi-v1.md#get-mta-alert)
            
        *   [Activate or deactivate an alert](./cpapi-v1.md#activate-alert)
            
        *   [Delete an alert](./cpapi-v1.md#delete-alert)
            
    *   [Accounts](./cpapi-v1.md#accounts)
        *   [Account Profit and Loss](./cpapi-v1.md#account-pnl)
            
        *   [Search Dynamic Account](./cpapi-v1.md#get-dynamic-account)
            
        *   [Set Dynamic Account](./cpapi-v1.md#set-dynamic-account)
            
        *   [Signatures and Owners](./cpapi-v1.md#sign-and-owners)
            
        *   [Switch Account](./cpapi-v1.md#switch-account)
            
        *   [Receive Brokerage Accounts](./cpapi-v1.md#get-brokerage-accounts)
            
    *   [Contract](./cpapi-v1.md#contract)
        *   [Search the security definition by Contract ID](./cpapi-v1.md#trsrv-conid-contract)
            
        *   [All Conids by Exchange](./cpapi-v1.md#exchange-conids)
            
        *   [Contract information by Contract ID](./cpapi-v1.md#info-conid-contract)
            
        *   [Currency Pairs](./cpapi-v1.md#get-currency-pairs)
            
        *   [Currency Exchange Rate](./cpapi-v1.md#get-exchange-rate)
            
        *   [Find all Info and Rules for a given contract](./cpapi-v1.md#info-rules-contract)
            
        *   [Search Algo Params by Contract ID](./cpapi-v1.md#algo-conid-contract)
            
        *   [Search Bond Filter Information](./cpapi-v1.md#search-bond-filters)
            
        *   [Search Contract by Symbol](./cpapi-v1.md#search-symbol-contract)
            
        *   [Search Contract Rules](./cpapi-v1.md#rules-contract)
            
        *   [Search SecDef information by conid](./cpapi-v1.md#secdef-info-contract)
            
        *   [Search Strikes by Underlying Contract ID](./cpapi-v1.md#strike-conid-contract)
            
        *   [Security Future by Symbol](./cpapi-v1.md#trsrv-future-contract)
            
        *   [Security Stocks by Symbol](./cpapi-v1.md#trsrv-stock-contract)
            
        *   [Trading Schedule by Symbol](./cpapi-v1.md#trsrv-schedule-contract)
            
        *   [Trading Schedule (NEW)](./cpapi-v1.md#schedule)
            
    *   [Event Contracts](./cpapi-v1.md#event-contracts)
        *   [Categorization](./cpapi-v1.md#event-contract-categories)
            
        *   [Markets and Strikes](./cpapi-v1.md#event-contract-markets)
            
        *   [Contract Rules](./cpapi-v1.md#contract-rules)
            
        *   [Trading schedule](./cpapi-v1.md#trading-schedule)
            
        *   [Contract details](./cpapi-v1.md#contract-details-forecastx)
            
        *   [Order Submission](./cpapi-v1.md#event-contract-orders)
            
        *   [Executions and Netting](./cpapi-v1.md#event-contract-netting)
            
    *   [FA Allocation Management](./cpapi-v1.md#fa-mgmt)
        *   [Allocatable Sub-Accounts](./cpapi-v1.md#fa-sub-accounts)
            
        *   [List All Allocation Groups](./cpapi-v1.md#fa-groups)
            
        *   [Retrieve Single Allocation Group](./cpapi-v1.md#fa-group-single)
            
        *   [Add Allocation Group](./cpapi-v1.md#fa-add-group)
            
        *   [Modify Allocation Group](./cpapi-v1.md#fa-group-modify)
            
        *   [Delete Allocation Group](./cpapi-v1.md#fa-group-delete)
            
        *   [Retrieve Allocation Presets](./cpapi-v1.md#fa-get-presets)
            
        *   [Set Allocation Presets](./cpapi-v1.md#fa-set-presets)
            
        *   [Allocation Method Codes](./cpapi-v1.md#fa-allocation-methods)
            
        *   [Allocation Preset Combinations](./cpapi-v1.md#fa-allocation-presets)
            
    *   [FYIs and Notifications](./cpapi-v1.md#fyi)
        *   [Unread Bulletins](./cpapi-v1.md#unread-bulletins)
            
        *   [Get a List of Subscriptions](./cpapi-v1.md#bulletin-subscriptions)
            
        *   [Enable/Disable Specified Subscription](./cpapi-v1.md#enable-subscription)
            
        *   [FYI Typecodes](./cpapi-v1.md#fyi-typecode)
            
        *   [Get disclaimer for a certain kind of fyi](./cpapi-v1.md#get-disclaimers)
            
        *   [Mark Disclaimer Read](./cpapi-v1.md#read-disclaimer)
            
        *   [Get Delivery Options](./cpapi-v1.md#get-delivery)
            
        *   [Enable/Disable Device Option](./cpapi-v1.md#enable-device)
            
        *   [Delete a Device](./cpapi-v1.md#delete-device)
            
        *   [Enable/Disable Email Option](./cpapi-v1.md#enable-email)
            
        *   [Get a list of notifications](./cpapi-v1.md#notification-list)
            
        *   [Mark Notification Read](./cpapi-v1.md#read-notification)
            
        *   [Event contract category and market tree](./cpapi-v1.md#category-tree)
            
    *   [Market Data](./cpapi-v1.md#md)
        *   [Live Market Data Snapshot](./cpapi-v1.md#md-snapshot)
            
        *   [Market Data Update Frequency](./cpapi-v1.md#md-update-freq)
            
        *   [Regulatory Snapshot](./cpapi-v1.md#regulatory-snapshot)
            
        *   [Market Data Availability](./cpapi-v1.md#md-availability)
            
        *   [Market Data Fields](./cpapi-v1.md#market-data-fields)
            
        *   [Unavailable Historical Data](./cpapi-v1.md#unavailable-hist-data)
            
        *   [Historical Market Data](./cpapi-v1.md#hist-md)
            
        *   [HMDS Period & Bar Size](./cpapi-v1.md#hmds-period-bar-size)
            
        *   [Unsubscribe (Single)](./cpapi-v1.md#md-unsubscribe-single)
            
        *   [Unsubscribe (All)](./cpapi-v1.md#md-unsubscribe-all)
            
    *   [Option Chains](./cpapi-v1.md#option-chain)
        *   [Step One: Instantiate the Option Chain](./cpapi-v1.md#oc-step-one)
            
        *   [Step Two: Find Potential Strikes](./cpapi-v1.md#oc-step-two)
            
        *   [Step Three: Validate The Contract](./cpapi-v1.md#oc-step-three)
            
        *   [Final Steps](./cpapi-v1.md#oc-final)
            
    *   [Order Monitoring](./cpapi-v1.md#order-monitor)
        *   [Live Orders](./cpapi-v1.md#live-orders)
            
        *   [Order Status](./cpapi-v1.md#order-status)
            
        *   [Order Status Value](./cpapi-v1.md#order-status-value)
            
        *   [Trades](./cpapi-v1.md#trades)
            
    *   [Orders](./cpapi-v1.md#orders)
        *   [Place Order](./cpapi-v1.md#place-order)
            
        *   [Cash Quantity Orders in the Web API](./cpapi-v1.md#cash-qty)
            
        *   [Place Order Reply Confirmation](./cpapi-v1.md#place-order-reply)
            
        *   [Respond to a Server Prompt](./cpapi-v1.md#place-order-ntf-confirm)
            
        *   [Preview Order / WhatIf Order](./cpapi-v1.md#whatif-order)
            
        *   [Overnight Order Submission](./cpapi-v1.md#overnight-orders)
            
        *   [Bracket Orders & OCA Groups](./cpapi-v1.md#bracket-orders)
            
        *   [Combo / Spread Orders](./cpapi-v1.md#combo-orders)
            
        *   [Cancel Order](./cpapi-v1.md#cancel-order)
            
        *   [Modify Order](./cpapi-v1.md#modify-order)
            
        *   [Suppress Messages](./cpapi-v1.md#questions-suppress)
            
        *   [Suppressible MessageIds](./cpapi-v1.md#suppressible-id)
            
        *   [Reset Suppressed Messages](./cpapi-v1.md#reset-questions-suppress)
            
    *   [Portfolio](./cpapi-v1.md#portfolio)
        *   [Portfolio Accounts](./cpapi-v1.md#portfolio-accounts)
            
        *   [Portfolio Subaccounts](./cpapi-v1.md#portfolio-subaccounts)
            
        *   [Portfolio Subaccounts (Large Account Structures)](./cpapi-v1.md#portfolio-subaccounts2)
            
        *   [Specific Account's Portfolio Information](./cpapi-v1.md#portfolio-meta)
            
        *   [Portfolio Allocation (Single)](./cpapi-v1.md#portfolio-allocation-single)
            
        *   [Combination Positions](./cpapi-v1.md#portfolio-combo)
            
        *   [Portfolio Allocation (All)](./cpapi-v1.md#portfolio-allocation-all)
            
        *   [Positions](./cpapi-v1.md#positions)
            
        *   [Positions (NEW)](./cpapi-v1.md#positions2)
            
        *   [Positions by Conid](./cpapi-v1.md#contract-positions)
            
        *   [Invalidate Backend Portfolio Cache](./cpapi-v1.md#portfolio-invalidate)
            
        *   [Portfolio Summary](./cpapi-v1.md#portfolio-summary)
            
        *   [Portfolio Ledger](./cpapi-v1.md#portfolio-ledger)
            
        *   [Position & Contract Info](./cpapi-v1.md#position-contract-info)
            
    *   [PortfolioAnalyst](./cpapi-v1.md#pa)
        *   [All Periods](./cpapi-v1.md#pa-all-periods)
            
        *   [Account Performance](./cpapi-v1.md#pa-account-performance)
            
        *   [Transaction History](./cpapi-v1.md#pa-transaction-history)
            
    *   [Scanner](./cpapi-v1.md#scanner)
        *   [Iserver Scanner Parameters](./cpapi-v1.md#iserver-scanner-parameters)
            
        *   [Iserver Market Scanner](./cpapi-v1.md#iserver-market-scanner)
            
        *   [HMDS Market Scanner](./cpapi-v1.md#hmds-market-scanner)
            
    *   [Session](./cpapi-v1.md#session)
        *   [Authentication Status](./cpapi-v1.md#auth-status)
            
        *   [Initialize Brokerage Session](./cpapi-v1.md#ssodh-init)
            
        *   [Logout of the current session](./cpapi-v1.md#logout)
            
        *   [Ping the server](./cpapi-v1.md#tickle)
            
        *   [Re-authenticate the Brokerage Session (Deprecated)](./cpapi-v1.md#reauthenticate)
            
        *   [Validate SSO](./cpapi-v1.md#sso-validate)
            
    *   [Watchlists](./cpapi-v1.md#watchlists)
        *   [Create a Watchlist](./cpapi-v1.md#create-watchlist)
            
        *   [Get All Watchlists](./cpapi-v1.md#all-watchlists)
            
        *   [Get Watchlist Information](./cpapi-v1.md#watchlist-info)
            
        *   [Delete a Watchlist](./cpapi-v1.md#delete-watchlist)
            
*   [Websockets](./cpapi-v1.md#websockets)
    *   [Connection Guide](./cpapi-v1.md#ws-connection-guide)
        *   [Request Session Information](./cpapi-v1.md#ws-connection-1)
            
        *   [Retrieve the Session Token](./cpapi-v1.md#ws-connection-2)
            
        *   [Establishing the Websocket with Client Portal Gateway](./cpapi-v1.md#ws-connection-3a)
            
        *   [Establishing the Websocket with OAuth](./cpapi-v1.md#ws-connection-3b)
            
        *   [Send a Websocket Topic](./cpapi-v1.md#ws-connection-4)
            
    *   [Solicited and Unsolicited Messages](./cpapi-v1.md#ws-messages)
        
    *   [Subscribing to Websocket Topics](./cpapi-v1.md#ws-subscribing-topics)
        
    *   [Account Operations](./cpapi-v1.md#ws-account)
        *   [Subscribe Account Summary](./cpapi-v1.md#ws-sub-account-summary)
            
        *   [Unsubscribe Account Summary](./cpapi-v1.md#ws-unsub-account-summary)
            
        *   [Subscribe Account Ledger](./cpapi-v1.md#ws-account-ledger)
            
        *   [Unsubscribe Account Ledger](./cpapi-v1.md#ws-unsub-account-ledger)
            
    *   [Market Data](./cpapi-v1.md#ws-market-data)
        *   [Market Data Request](./cpapi-v1.md#ws-sub-watchlist-data)
            
        *   [Cancel Market Data](./cpapi-v1.md#ws-cancel-watchlist-data)
            
        *   [Historical Market Data Request](./cpapi-v1.md#ws-sub-historical-data)
            
        *   [Cancel Historical Market Data](./cpapi-v1.md#ws-historical-data-cancel)
            
        *   [Subscribe to BookTrader Price Ladder](./cpapi-v1.md#ws-price-ladder-sub)
            
        *   [Cancel Price Ladder Subscription](./cpapi-v1.md#ws-price-ladder-cancel)
            
    *   [Miscellaneous Operations](./cpapi-v1.md#ws-misc)
        *   [Exercise Options](./cpapi-v1.md#option-exercise)
            
        *   [Ping Session](./cpapi-v1.md#ws-ping)
            
    *   [Order & Position Operations](./cpapi-v1.md#ws-orders-positions)
        *   [Request Live Order Updates](./cpapi-v1.md#ws-order-updates-sub)
            
        *   [Cancel Live Order Updates](./cpapi-v1.md#ws-order-updates-cancel)
            
        *   [Request Profit & Loss](./cpapi-v1.md#ws-pnl-sub)
            
        *   [Cancel Profit & Loss](./cpapi-v1.md#ws-pnl-cancel)
            
        *   [Request Trades data](./cpapi-v1.md#ws-trades-sub)
            
        *   [Cancel Trades data](./cpapi-v1.md#ws-trades-cancel)
            
    *   [Unsolicited Messages](./cpapi-v1.md#ws-auto-responses)
        *   [Account Updates](./cpapi-v1.md#ws-account-updates)
            
        *   [Authentication Status](./cpapi-v1.md#ws-auth-status)
            
        *   [Bulletins](./cpapi-v1.md#ws-bulletins)
            
        *   [System Connection Messages](./cpapi-v1.md#ws-system-messages)
            
        *   [Notifications](./cpapi-v1.md#ws-notifications)
            
*   [OAuth 1.0a](./cpapi-v1.md#oauth-10a)
    *   [Introduction](./cpapi-v1.md#oauth-introduction)
        
    *   [First Party Oauth](./cpapi-v1.md#first-party-oauth)
        *   [First Party OAuth Workflow](./cpapi-v1.md#first-party-oauth-workflow)
            
    *   [Third Party OAuth](./cpapi-v1.md#third-party-oauth)
        *   [Third Party OAuth Workflow](./cpapi-v1.md#third-party-oauth-workflow)
            
    *   [Understanding TESTCONS](./cpapi-v1.md#testcons)
        
    *   [OAuth 1.0a Python Libraries](./cpapi-v1.md#useful-libraries)
        
    *   [Request Token](./cpapi-v1.md#request-token)
        *   [Endpoint](./cpapi-v1.md#request-token-endpoint)
            
        *   [OAuth Parameters](./cpapi-v1.md#request-token-params)
            
        *   [Request](./cpapi-v1.md#request-token-request)
            
        *   [Response](./cpapi-v1.md#request-token-response)
            
    *   [Authorization](./cpapi-v1.md#oauth-authorize)
        *   [Endpoint](./cpapi-v1.md#oauth-authorize-endpoint)
            
        *   [Request](./cpapi-v1.md#oauth-authorize-request)
            
        *   [Response](./cpapi-v1.md#oauth-authorize-response)
            
    *   [Access Token](./cpapi-v1.md#access-token)
        *   [Endpoint](./cpapi-v1.md#access-token-endpoint)
            
        *   [OAuth Params](./cpapi-v1.md#access-token-params)
            
        *   [Request](./cpapi-v1.md#access-token-request)
            
        *   [Response](./cpapi-v1.md#access-token-response)
            
    *   [Live Session Token](./cpapi-v1.md#lst)
        *   [Endpoint](./cpapi-v1.md#lst-endpoint)
            
        *   [Diffie-Hellman Random Value](./cpapi-v1.md#lst-random)
            
        *   [Diffie-Hellman Challenge](./cpapi-v1.md#lst-challenge)
            
        *   [Prepend](./cpapi-v1.md#lst-prepend)
            
        *   [OAuth Params](./cpapi-v1.md#lst-params)
            
        *   [Encoded Base String](./cpapi-v1.md#lst-base-string)
            
        *   [OAuth Signature](./cpapi-v1.md#lst-signature)
            
        *   [Realm](./cpapi-v1.md#lst-realm)
            
        *   [Authorization Header](./cpapi-v1.md#lst-auth-header)
            
        *   [Required Headers](./cpapi-v1.md#lst-headers)
            
        *   [Request](./cpapi-v1.md#lst-request)
            
        *   [Response](./cpapi-v1.md#lst-response)
            
    *   [Computing The Live Session Token](./cpapi-v1.md#compute-lst)
        *   [Prepend Bytes](./cpapi-v1.md#compute-prepend)
            
        *   [Calculating K](./cpapi-v1.md#calculate-k)
            
        *   [Final Live Session Calculation](./cpapi-v1.md#compute-caclulation)
            
    *   [Validate Live Session Token](./cpapi-v1.md#validate-lst)
        
    *   [Authenticated Requests With OAuth 1.0A](./cpapi-v1.md#standard-oauth)
        *   [Initial OAuth Params](./cpapi-v1.md#standard-params)
            
        *   [Encoded Base String](./cpapi-v1.md#standard-base-string)
            
        *   [OAuth Signature](./cpapi-v1.md#standard-signature)
            
        *   [Realm](./cpapi-v1.md#standard-realm)
            
        *   [Authorization Header](./cpapi-v1.md#standard-auth-header)
            
        *   [Required Headers](./cpapi-v1.md#standard-headers)
            
        *   [Submit The Request](./cpapi-v1.md#standard-submission)
            
*   [Flex Web Service](./cpapi-v1.md#flex-intro)
    *   [Client Portal Configuration](./cpapi-v1.md#configuration)
        *   [Enable and Create Access Token](./cpapi-v1.md#create-token)
            
        *   [Create a Flex Query](./cpapi-v1.md#create-flex-query)
            
        *   [Including Audit Trail Fields](./cpapi-v1.md#flex-audit-trail)
            
    *   [Using Flex Web Service](./cpapi-v1.md#flex-usage)
        *   [Generate a Report](./cpapi-v1.md#flex-generate-report)
            
        *   [Make request to /SendRequest](./cpapi-v1.md#request-sendrequest)
            
        *   [Success response from /SendRequest](./cpapi-v1.md#response-sendrequest-success)
            
        *   [Failure response from /SendRequest](./cpapi-v1.md#response-sendrequest-failure)
            
        *   [Retrieve the Report](./cpapi-v1.md#retrieve-report)
            
        *   [Make request to /GetStatement](./cpapi-v1.md#request-getstatement)
            
    *   [Error Codes](./cpapi-v1.md#error-codes)
...
Interactive Brokers’ Client Portal Web API delivers real-time access to Interactive Brokers’ trading functionality, including live market data, market scanners, and intra-day portfolio updates. Clients can communicate directly with IBKR infrastructure, both synchronously using HTTP endpoints and in an asynchronous, event-driven manner via websocket. A variety of [authorization and authentication](./cpapi-v1.md#authentication)
 methods are available to accommodate any use case, including OAuth 1.0a, OAuth 2.0, SSO, and our Java-based CP Gateway tool.

An active Interactive Brokers account is required in order to use the Client Portal API. If you do not already have an account, you can [create one for free](https://www.interactivebrokers.com/en/index.php?f=46380#open-account)
. Please note that you will have to wait for the account to be fully activated before connecting to the API.
...
CIRO has implemented [IIROC Dealer Member Rule (DMR) 3200](https://www.ciro.ca/sites/default/files/legacy/2021-09/RulesCollated_090121_en.pdf)
 A. 1. (b) (i) which prohibits CIRO registrants, including IBC, from allowing its clients to use their own automated order systems to generated orders.
...
[Download the Standard Release](https://download2.interactivebrokers.com/portal/clientportal.gw.zip)
 [Download the Beta Release](https://download2.interactivebrokers.com/portal/clientportal.beta.gw.zip)
...
After successfully running the gateway, you may proceed through the [Authentication](./cpapi-v1.md#authentication)
 steps before proceeding to calling your requested endpoints.

Using the terminal, Find and open the unzipped Client Portal Gateway directory.

For example, assume my Client Portal Gateway directory is in the Windows _C:/Users/Example/Downloads/_ , then I can run the following command to change to the directory:
...
ip2loc: "US" proxyRemoteSsl: true proxyRemoteHost: "https://api.ibkr.com" listenPort: 5001 listenSsl: true ccp: false svcEnvironment: "v1" sslCert: "vertx.jks" sslPwd: "mywebapi" authDelay: 3000 portalBaseURL: "" serverOptions: blockedThreadCheckInterval: 1000000 eventLoopPoolSize: 20 workerPoolSize: 20 maxWorkerExecuteTime: 100 internalBlockingPoolSize: 20 webApps: - name: "demo" index: "index.html" cors: origin.allowed: "\*" allowCredentials: false ips: allow: - 192.\* deny:
...
After launching the client portal gateway, navigate to localhost:5000 and sign in using your standard Interactive Brokers credentials. After entering your username and password, you will be prompted for Two-Factor Authentication based on your authentication method of choice. After entering your information, you will see  

Client login succeeds

`Client login succeeds` to indicate a successful login.

If you are signing in with your paper account, be sure to use the unique Paper Trading username. This can be found by logging in to the [Client Portal](https://www.interactivebrokers.com/en/home.php)
 with your live account’s username then selecting the Head and Shoulders icon in the top right corner and click Settings. Here, you should see a link for Paper Trading account. This will list your Paper Account’s account ID and username.
...
5.  After logging in with OAuth without competing sessions, you will have a Portal session and can visit non-iserver resources. The additional [/iserver/auth/ssodh/init](./cpapi-v1.md#ssodh-init)
     endpoint is used to subsequently reopen a brokerage session with our backend, through which you can access the protected /iserver endpoints.
...
2.  Select the Head & Shoulders Icon   ![client portal head and shoulders icon.](<Base64-Image-Removed>)
    
    ![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/headAndShoulders.png)
...
The endpoint **iserver/auth/status** can be used to determine the current authentication status of the session. Once you have logged in using the Client Portal API Gateway, you can make a request to this endpoint to determine if your session is fully authenticated. If the session is fully authenticated, the response from this endpoint will display  
...
Sessions will time out after approximately 6 minutes without sending new requests or maintaining the [/tickle endpoint](./cpapi-v1.md#tickle)
...
If the brokerage session has timed out but the session is still connected to the IBKR backend, the response to **/auth/status** returns ‘connected’:true and ‘authenticated’:false. Calling the [/iserver/auth/ssodh/init](./cpapi-v1.md#ssodh-init)
 endpoint will initialize a new brokerage session.
...
The base url for the [Client Portal Gateway](./cpapi-v1.md#cpgw)
...
Python web requests are displayed with various external libraries that users may wish to implement. While this documentation is built around the _requests_ library, there are a few additional libraries to consider:
...
Please note that cURL requests are formatted using the cURL standard, [documented here](https://curl.se/docs/manpage.html)
. Some OS specific platforms may be unique, and will require some adjustment.
...
request\_url = f"{baseUrl}/iserver/account/U1234567/alert"

json\_content = {

"alertMessage": "AAPL Price Drop!",

"alertName": "AAPL\_Price",
...
requests.post(url=request\_url, json=json\_content)

request\_url = f"{baseUrl}/iserver/account/U1234567/alert" json\_content = { "alertMessage": "AAPL Price Drop!", "alertName": "AAPL\_Price", "expireTime":"20270101-12:00:00", "alertRepeatable": 0, "outsideRth": 0, "sendMessage": 1, "email": "user@domain.net", "iTWSOrdersOnly": 0, "showPopup": 0, "tif": "GTD", "conditions": \[{ "conidex": "265598@SMART", "logicBind": "n", "operator": "<=", "triggerMethod": 0, "type": 1, "value": "183.34" }\] } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/account/U1234567/alert \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "alertMessage": "AAPL Price Drop!", "alertName": "AAPL\_Price", "expireTime":"20231231-12:00:00", "alertRepeatable": 0, "outsideRth": 0, "sendMessage": 0, "email": "user@domain.net", "iTWSOrdersOnly": 0, "showPopup": 0, "tif": "GTD", "conditions": \[{ "conidex": "265598@SMART", "logicBind": "n", "operator": "<=, "triggerMethod": 0, "type": 1, "value": "183.34" }\] }'
...
"warning\_message": null

}

{ "request\_id": null, "order\_id": 9876543210, "success": true, "text": "Submitted", "order\_status": null, "warning\_message": null }
...
request\_url = f"{baseUrl}/iserver/account/U1234567/alerts"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/account/U1234567/alerts" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/account/U1234567/alerts \\ --request GET
...
"account": "U1234567",\
\
"alert\_name": "AAPL Price",\
\
"alert\_active": 1,\
\
"order\_time": "20231211-18:55:35",\
\
...
\[ { "order\_id": 9876543210, "account": "U1234567", "alert\_name": "AAPL Price", "alert\_active": 1, "order\_time": "20231211-18:55:35", "alert\_triggered": false, "alert\_repeatable": 0 } \]
...
GET /iserver/account/alert/{{ order\_id }}

`GET /iserver/account/alert/{{ order_id }}`

###### Path Parameters

**order\_id:** _int_**.** Required  
...
request\_url = f"{baseUrl}/iserver/account/alert/9876543210?type=Q"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/account/alert/9876543210?type=Q" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/account/alert/9876543210?type=Q \\ --request GET
...
"expire\_time": "20231231-12:00:00",
...
"alert\_send\_message": 0,

"alert\_message": "MTA TEST!",

"alert\_show\_popup": 0,

"alert\_play\_audio": null,
...
"order\_not\_editable": false,

"itws\_orders\_only": 0,

"alert\_mta\_currency": null,

"alert\_mta\_defaults": null,

"tool\_id": null,

"time\_zone": null,

"alert\_default\_type": null,

"condition\_size": 1,

"condition\_outside\_rth": 0,
...
"condition\_operator": "<=",\
\
"condition\_trigger\_method": "0",\
\
"condition\_value": "183.34",\
\
"condition\_logic\_bind": "n",\
\
"condition\_time\_zone": null\
\
}\
\
\]
...
{ "account": "U1234567", "order\_id": 9876543210, "alert\_name": "AAPL Price", "tif": "GTD", "expire\_time": "20231231-12:00:00", "alert\_active": 1, "alert\_repeatable": 0, "alert\_email": null, "alert\_send\_message": 0, "alert\_message": "MTA TEST!", "alert\_show\_popup": 0, "alert\_play\_audio": null, "order\_status": "Submitted", "alert\_triggered": false, "fg\_color": "#FFFFFF", "bg\_color": "#0000CC", "order\_not\_editable": false, "itws\_orders\_only": 0, "alert\_mta\_currency": null, "alert\_mta\_defaults": null, "tool\_id": null, "time\_zone": null, "alert\_default\_type": null, "condition\_size": 1, "condition\_outside\_rth": 0, "conditions": \[ { "condition\_type": 1, "conidex": "265598@SMART", "contract\_description\_1": "AAPL", "condition\_operator": "<=", "condition\_trigger\_method": "0", "condition\_value": "183.34", "condition\_logic\_bind": "n", "condition\_time\_zone": null } \] }
...
request\_url = f"{baseUrl}/iserver/account/mta"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/account/mta" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/account/mta \\ --request GET
...
"alert\_mta\_currency": "USD",

"alert\_mta\_defaults": "9:STATE=1,MIN=-43115000,MAX=43115000,STEP=500,DEF\_MIN=-4311500,DEF\_MAX=4311500|{{...}}",

"tool\_id": 55834574848,

"time\_zone": "GMT (GMT),GMT (Africa/Abidjan),{{...}}",
...
{ "account": "U1234567", "order\_id": 9998887776, "alert\_name": null, "tif": "GTC", "expire\_time": null, "alert\_active": 1, "alert\_repeatable": 1, "alert\_email": null, "alert\_send\_message": 1, "alert\_message": null, "alert\_show\_popup": 0, "alert\_play\_audio": null, "order\_status": "Inactive", "alert\_triggered": false, "fg\_color": "#000000", "bg\_color": "#AFAFAF", "order\_not\_editable": false, "itws\_orders\_only": 0, "alert\_mta\_currency": "USD", "alert\_mta\_defaults": "9:STATE=1,MIN=-43115000,MAX=43115000,STEP=500,DEF\_MIN=-4311500,DEF\_MAX=4311500|{{...}}", "tool\_id": 55834574848, "time\_zone": "GMT (GMT),GMT (Africa/Abidjan),{{...}}", "alert\_default\_type": null, "condition\_size": 0, "condition\_outside\_rth": 0, "conditions": \[\] }
...
request\_url = f"{baseUrl}/iserver/account/U1234567/alert/activate"
...
request\_url = f"{baseUrl}/iserver/account/U1234567/alert/activate" --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "alertId": 9876543210, "alertActive": 1 }'
...
curl \\ --url {{baseUrl}}/iserver/account/U1234567/alert/activate \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "alertId": 9876543210, "alertActive": 1 }'
...
{ "request\_id": null, "order\_id": 9876543210, "success": true, "text": "Request was submitted", "failure\_list": null }
...
request\_url = f"{baseUrl}/iserver/account/U1234567/alert/9876543210"

json\_content = {}

requests.delete(url=request\_url, json=json\_content)

request\_url = f"{baseUrl}/iserver/account/U1234567/alert/9876543210" json\_content = {} requests.delete(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/account/U1234567/alert/9876543210 \\ --request DELETE
...
request\_url = f"{baseUrl}/iserver/account/pnl/partitioned"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/account/pnl/partitioned" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/account/pnl/partitioned \\ --request GET
...
request\_url f"{baseUrl}/iserver/account/search/U123" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/account/search/U123 \\ --request GET
...
Set the active dynamic account. Values retrieved from [Search Dynamic Account](./cpapi-v1.md#get-dynamic-account)
...
request\_url = f"{baseUrl}/iserver/dynaccount"
...
request\_url = f"{baseUrl}/iserver/dynaccount" json\_content = { "acctId": "U1234567 } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/dynaccount \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "acctId": "U1234567 }'
...
request\_url = f"{baseUrl}/acesws/U1234567/signatures-and-owners"

request.get(url=request\_url)

request\_url = f"{baseUrl}/acesws/U1234567/signatures-and-owners" request.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/acesws/U1234567/signatures-and-owners \\ --request GET
...
request\_url = f"{baseUrl}/iserver/account"
...
request\_url = f"{baseUrl}/iserver/account" json\_content = { "acctId": "U1234567, } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/account \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "acctId": "U1234567, }'
...
request\_url = f"{baseUrl}/iserver/accounts"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/accounts" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/accounts \\ --request GET
...
Returns currently selected account. See [Switch Account](./cpapi-v1.md#switch-account)
 for more details.
...
request\_url = f"{baseUrl}/trsrv/secdef?conids=265598"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/trsrv/secdef?conids=265598" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/trsrv/secdef?conids=265598 \\ --request GET
...
Returns rules regarding incrementation for order placement. Not functional for all exchanges. Please see [/iserver/contract/rules](./cpapi-v1.md#rules-contract)
 for more accurate rule details.
...
request\_url = f"{baseUrl}/trsrv/all-conids?exchange=AMEX"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/trsrv/all-conids?exchange=AMEX" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/trsrv/all-conids?exchange=AMEX \\ --request GET
...
request\_url = f"{baseUrl}/iserver/contract/265598/info"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/contract/265598/info" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/contract/265598/info \\ --request GET
...
"instrument\_type": "STK",

"trading\_class": "NMS",

"valid\_exchanges": "SMART,AMEX,NYSE,CBOE,PHLX,ISE,CHX,ARCA,ISLAND,DRCTEDGE,BEX,BATS,EDGEA,JEFFALGO,BYX,IEX,EDGX,FOXRIVER,PEARL,NYSENAT,LTSE,MEMX,TPLUS1,IBEOS,OVERNIGHT,PSX",

"allow\_sell\_long": false,

"is\_zero\_commission\_security": false,
...
"underlying\_con\_id": 0,

"r\_t\_h": true,

"multiplier": null,

"underlying\_issuer": null,

"contract\_month": null,

"company\_name": "APPLE INC",

"smart\_available": true,
...
{ "cfi\_code": "", "symbol": "AAPL", "cusip": null, "expiry\_full": null, "con\_id": 265598, "maturity\_date": null, "industry": "Computers", "instrument\_type": "STK", "trading\_class": "NMS", "valid\_exchanges": "SMART,AMEX,NYSE,CBOE,PHLX,ISE,CHX,ARCA,ISLAND,DRCTEDGE,BEX,BATS,EDGEA,JEFFALGO,BYX,IEX,EDGX,FOXRIVER,PEARL,NYSENAT,LTSE,MEMX,TPLUS1,IBEOS,OVERNIGHT,PSX", "allow\_sell\_long": false, "is\_zero\_commission\_security": false, "local\_symbol": "AAPL", "contract\_clarification\_type": null, "classifier": null, "currency": "USD", "text": null, "underlying\_con\_id": 0, "r\_t\_h": true, "multiplier": null, "underlying\_issuer": null, "contract\_month": null, "company\_name": "APPLE INC", "smart\_available": true, "exchange": "SMART", "category": "Computers" }
...
request\_url = f"{baseUrl}/iserver/currency/pairs?currency=USD"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/currency/pairs?currency=USD" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/currency/pairs?currency=USD \\ --request GET
...
request\_url = f"{baseUrl}/iserver/exchangerate?target=AUD&source=USD"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/exchangerate?target=AUD&source=USD" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/exchangerate?target=AUD&source=USD \\ --request GET
...
request\_url = f"{baseUrl}/iserver/contract/265598/info-and-rules?isBuy=true"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/contract/265598/info-and-rules?isBuy=true" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/contract/265598/info-and-rules?isBuy=true \\ --request GET
...
**rules:** Object.  
[See the](./cpapi-v1.md#rules-contract)

[/iserver/contract/rules](./cpapi-v1.md#rules-contract)

[`/iserver/contract/rules`](./cpapi-v1.md#rules-contract)
 [endpoint.](./cpapi-v1.md#rules-contract)
...
"tifTypes": \[\
\
"IOC/MARKET,LIMIT,RELATIVE,MARKETONCLOSE,MIDPRICE,LIMITONCLOSE,MKT\_PROTECT,STPPRT,a",\
\
"GTC/o,a",\
\
"OPG/LIMIT,MARKET,a",\
...
{ "cfi\_code": "", "symbol": "AAPL", "cusip": null, "expiry\_full": null, "con\_id": 265598, "maturity\_date": null, "industry": "Computers", "instrument\_type": "STK", "trading\_class": "NMS", "valid\_exchanges": "SMART,AMEX,NYSE,CBOE,PHLX,ISE,CHX,ARCA,ISLAND,DRCTEDGE,BEX,BATS,EDGEA,JEFFALGO,BYX,IEX,EDGX,FOXRIVER,PEARL,NYSENAT,LTSE,MEMX,TPLUS1,IBEOS,OVERNIGHT,PSX", "allow\_sell\_long": false, "is\_zero\_commission\_security": false, "local\_symbol": "AAPL", "contract\_clarification\_type": null, "classifier": null, "currency": "USD", "text": null, "underlying\_con\_id": 0, "r\_t\_h": true, "multiplier": null, "underlying\_issuer": null, "contract\_month": null, "company\_name": "APPLE INC", "smart\_available": true, "exchange": "SMART", "category": "Computers", "rules": { "algoEligible": true, "overnightEligible": true, "costReport": false, "canTradeAcctIds": \[ "U1234567" \], "error": null, "orderTypes": \[ "limit", "midprice", "market", "stop", "stop\_limit", "mit", "lit", "trailing\_stop", "trailing\_stop\_limit", "relative", "marketonclose", "limitonclose" \], "ibAlgoTypes": \[ "limit", "stop\_limit", "lit", "trailing\_stop\_limit", "relative", "marketonclose", "limitonclose" \], "fraqTypes": \[ "limit", "market", "stop", "stop\_limit", "mit", "lit", "trailing\_stop", "trailing\_stop\_limit" \], "forceOrderPreview": false, "cqtTypes": \[ "limit", "market", "stop", "stop\_limit", "mit", "lit", "trailing\_stop", "trailing\_stop\_limit" \], "orderDefaults": { "LMT": { "LP": "197.93" } }, "orderTypesOutside": \[ "limit", "stop\_limit", "lit", "trailing\_stop\_limit", "relative" \], "defaultSize": 100, "cashSize": 0.0, "sizeIncrement": 100, "tifTypes": \[ "IOC/MARKET,LIMIT,RELATIVE,MARKETONCLOSE,MIDPRICE,LIMITONCLOSE,MKT\_PROTECT,STPPRT,a", "GTC/o,a", "OPG/LIMIT,MARKET,a", "GTD/o,a", "DAY/o,a" \], "tifDefaults": { "TIF": "DAY", "SIZE": "100.00" }, "limitPrice": 197.93, "stopprice": 197.93, "orderOrigination": null, "preview": true, "displaySize": null, "fraqInt": 4, "cashCcy": "USD", "cashQtyIncr": 500, "priceMagnifier": null, "negativeCapable": false, "incrementType": 1, "incrementRules": \[ { "lowerEdge": 0.0, "increment": 0.01 } \], "hasSecondary": true, "increment": 0.01, "incrementDigits": 2 } }
...
request\_url = f"{baseUrl}/iserver/contract/265598/algos?algos=Adaptive;Vwap&addDescription=1&addParams=1"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/contract/265598/algos?algos=Adaptive;Vwap&addDescription=1&addParams=1" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/contract/265598/algos?algos=Adaptive;Vwap&addDescription=1&addParams=1 \\ --request GET
...
Request a list of filters relating to a given Bond issuerID. The issuerId is retrieved from [/iserver/secdef/search](./cpapi-v1.md#search-symbol-contract)
 and can be used in [/iserver/secdef/info?issuerId={{ issuerId }}](./cpapi-v1.md#secdef-info-contract)
...
request\_url = f"{baseUrl}/iserver/secdef/bond-filters?symbol=BOND&issuerId=e1400715"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/secdef/bond-filters?symbol=BOND&issuerId=e1400715" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/secdef/bond-filters?symbol=BOND&issuerId=e1400715 \\ --request GET
...
**name:** bool.  
Determines if symbol reflects company name or ticker symbol. If company name is included will only receive limited response: conid, companyName, companyHeader and symbol. The inclusion of the name field will prohibit the [/iserver/secdef/strikes](./cpapi-v1.md#strike-conid-contract)
 endpoint from returning data. After retrieving your expected contract, customers looking to create option chains should remove the name field from the request.
...
request\_url = f"{baseUrl}/iserver/secdef/search?symbol=Interactive Brokers&name=true"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/secdef/search?symbol=Interactive Brokers&name=true" requests.get(url=request\_url)
...
curl --insecure \\ --url https://localhost:5000/v1/api/iserver/secdef/search?symbol=Interactive Brokers&name=true \\ --request GET
...
\[ { "conid": "43645865", "companyHeader": "IBKR INTERACTIVE BROKERS GRO-CL A (NASDAQ) ", "companyName": "INTERACTIVE BROKERS GRO-CL A (NASDAQ)", "symbol": "IBKR", "description": null, "restricted": null, "sections": \[\], "secType": "STK" } \]
...
request\_url = f"{baseUrl}/iserver/contract/rules"
...
request\_url = f"{baseUrl}/iserver/contract/rules" json\_content = { "conid": 265598, "exchange": "SMART", "isBuy": true, "modifyOrder": true, "orderId": 1234567890 } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/contract/rules \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "conid": 265598, "exchange": "SMART", "isBuy": true, "modifyOrder": true, "orderId": 1234567890 }'
...
{ "algoEligible": true, "overnightEligible": true, "costReport": false, "canTradeAcctIds": \[ "U1234567" \], "error": null, "orderTypes": \[ "limit", "midprice", "market", "stop", "stop\_limit", "mit", "lit", "trailing\_stop", "trailing\_stop\_limit", "relative", "marketonclose", "limitonclose" \], "ibAlgoTypes": \[ "limit", "stop\_limit", "lit", "trailing\_stop\_limit", "relative", "marketonclose", "limitonclose" \], "fraqTypes": \[\], "forceOrderPreview": false, "cqtTypes": \[ "limit", "market", "stop", "stop\_limit", "mit", "lit", "trailing\_stop", "trailing\_stop\_limit" \], "orderDefaults": { "LMT": { "LP": "549000.00" } }, "orderTypesOutside": \[ "limit", "stop\_limit", "lit", "trailing\_stop\_limit", "relative" \], "defaultSize": 100, "cashSize": 0.0, "sizeIncrement": 1, "tifTypes": \[ "IOC/MARKET,LIMIT,RELATIVE,MARKETONCLOSE,MIDPRICE,LIMITONCLOSE,MKT\_PROTECT,STPPRT,a", "GTC/o,a", "OPG/LIMIT,MARKET,a", "GTD/o,a", "DAY/o,a" \], "tifDefaults": { "TIF": "DAY", "SIZE": "100.00" }, "limitPrice": 549000.0, "stopprice": 549000.0, "orderOrigination": null, "preview": true, "displaySize": null, "fraqInt": 0, "cashCcy": "USD", "cashQtyIncr": 500, "priceMagnifier": null, "negativeCapable": false, "incrementType": 1, "incrementRules": \[ { "lowerEdge": 0.0, "increment": 0.01 } \], "hasSecondary": true, "increment": 0.01, "incrementDigits": 2 }
...
For derivatives such as Options, Warrants, and Futures Options, you will need to query

/iserver/secdef/strikes

`/iserver/secdef/strikes` as well.
...
request\_url = f"{baseUrl}/iserver/secdef/info?conid=265598&secType=OPT&month=JAN24&strike=195&right=P"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/secdef/info?conid=265598&secType=OPT&month=JAN24&strike=195&right=P" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/secdef/info?conid=265598&secType=OPT&month=JAN24&strike=195&right=P \\ --request GET
...
This endpoint will always return empty arrays unless [/iserver/secdef/search](./cpapi-v1.md#search-symbol-contract)
 is called for the same underlying symbol beforehand. The inclusion of the name field with the [/iserver/secdef/search](./cpapi-v1.md#search-symbol-contract)
 endpoint will prohibit the strikes endpoint from returning data. After retrieving your expected contract from the initial search, developers looking to create option chains should remove the name field from the request.
...
request\_url = f"{baseUrl}/iserver/secdef/strikes?conid=265598&sectype=OPT&month=JAN24&exchange=SMART"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/secdef/strikes?conid=265598&sectype=OPT&month=JAN24&exchange=SMART" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/secdef/strikes?conid=265598&sectype=OPT&month=JAN24&exchange=SMART \\ --request GET
...
request\_url = f"{baseUrl}/trsrv/futures?symbols=ES,MES"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/trsrv/futures?symbols=ES,MES" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/trsrv/futures?symbols=ES,MES \\ --request GET
...
request\_url = f"{baseUrl}/trsrv/stocks?symbols=AAPL,IBKR"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/trsrv/stocks?symbols=AAPL,IBKR" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/trsrv/stocks?symbols=AAPL,IBKR\\ --request GET
...
request\_url = f"{baseUrl}/trsrv/secdef//schedule?assetClass=STK&conid=265598&symbol=AAPL&exchange=ISLAND&exchangeFilter=ISLAND"

requests.get(url=requests\_url)

request\_url = f"{baseUrl}/trsrv/secdef//schedule?assetClass=STK&conid=265598&symbol=AAPL&exchange=ISLAND&exchangeFilter=ISLAND" requests.get(url=requests\_url)
...
curl \\ --url {{baseUrl}}/secdef/trsrv/schedule?assetClass=STK&symbol=AAPL&exchange=ISLAND&exchangeFilter=ISLAND,NYSE,AMEX \\ --request GET
...
\[ { "id": "p102082", "tradeVenueId": "v13133", "timezone": "America/New\_York", "schedules": \[ { "clearingCycleEndTime": "2000", "tradingScheduleDate": "20000103", "sessions": \[ { "openingTime": "0930", "closingTime": "1600", "prop": "LIQUID" } \], "tradingtimes": \[ { "openingTime": "0400", "closingTime": "2000", "cancelDayOrders": "Y" } \] }, {...} \] } \]
...
request\_url = f"{baseUrl}/contract/trading-schedule?conid=265598&exchange=ISLAND"

requests.get(url=requests\_url)

request\_url = f"{baseUrl}/contract/trading-schedule?conid=265598&exchange=ISLAND" requests.get(url=requests\_url)
...
curl \\ --url {{baseUrl}}/contract/trading-schedule?conid=265598&exchange=ISLAND \\ --request GET
...
'exchange\_time\_zone': 'US/Central',
...
{ 'exchange\_time\_zone': 'US/Central', 'schedules': { '20251218': { 'extended\_hours': \[{ 'cancel\_daily\_orders': True, 'closing': 1766095200, 'opening': 1766012400}\], 'liquid\_hours': \[{ 'closing': 1766095200, 'opening': 1766068200 }\]}, '20251219': { 'extended\_hours': \[{ 'cancel\_daily\_orders': True, 'closing': 1766181600, 'opening': 1766098800}\], 'liquid\_hours': \[{ 'closing': 1766181600, 'opening': 1766154600 }\]}, '20251222': { 'extended\_hours': \[{ 'cancel\_daily\_orders': True, 'closing': 1766440800, 'opening': 1766358000}\], 'liquid\_hours': \[{ 'closing': 1766440800, 'opening': 1766413800 }\]}, '20251223': { 'extended\_hours': \[{ 'cancel\_daily\_orders': True, 'closing': 1766527200, 'opening': 1766444400 }\], 'liquid\_hours': \[{ 'closing': 1766527200, 'opening': 1766500200 }\]}, '20251224': { 'extended\_hours': \[{ 'cancel\_daily\_orders': True, 'closing': 1766600100, 'opening': 1766530800}\], 'liquid\_hours': \[{ 'closing': 1766600100, 'opening': 1766586600 }\]}, '20251226': { 'extended\_hours': \[{ 'cancel\_daily\_orders': True, 'closing': 1766786400, 'opening': 1766703600 }\]} } }
...
import requests url = "{{base-url}}/forecast/category/tree" payload = {} headers = {} response = requests.request("GET", url, headers=headers, data=payload) print(response.text)
...
{ "categories": { "g78664": { "name": "Northeast", "parent\_id": "g17457", "markets": \[ { "name": "Northeastern US CPI", "symbol": "RCNET", "exchange": "FORECASTX", "conid": 831072285, "product\_conid": 831072289 } \] }, }
...
import requests url = "{{base-url}}/forecast/contract/market?underlyingConid=766914406&exchange=FORECASTX" payload = {} headers = {} response = requests.request("GET", url, headers=headers, data=payload) print(response.text)
...
"market\_name": "Georgia Governor Democratic Primary",

"exchange": "FORECASTX",

"symbol": "GPGAD",

"logo\_category": "g17467",

"exclude\_historical\_data": true,
...
"strike": 1.0,\
\
"strike\_label": "Stacey Abrams",\
\
"expiry\_label": "2026",\
\
"underlying\_conid": 766914406,\
\
"time\_specifier": "2026.5.19"\
\
},\
\
}\
\
{ "market\_name": "Georgia Governor Democratic Primary", "exchange": "FORECASTX", "symbol": "GPGAD", "logo\_category": "g17467", "exclude\_historical\_data": true, "payout": 1.0, "contracts": \[ { "conid": 767285167, "side": "Y", "expiration": "20260612", "strike": 1.0, "strike\_label": "Stacey Abrams", "expiry\_label": "2026", "underlying\_conid": 766914406, "time\_specifier": "2026.5.19" }, }\
\
{\
    "market\_name": "Georgia Governor Democratic Primary",\
    "exchange": "FORECASTX",\
...
print(response.text)\
\
import requests url = "{{base-url}}/forecast/contract/rules?conid=767285167" payload = {} headers = {} response = requests.request("GET", url, headers=headers, data=payload) print(response.text)\
\
import requests\
\
url = "{{base-url}}/forecast/contract/rules?conid=767285167"\
...
"market\_name": "Georgia Governor Democratic Primary",\
\
"measured\_period": "May19'26",\
\
"threshold": "Stacey Abrams",\
\
"source\_agency": "Georgia Secretary of State Elections Division",\
\
"data\_and\_resolution\_link": "https://sos.ga.gov/index.php/elections",\
\
"last\_trade\_time": 1781301540,\
\
"product\_code": "GPGAD",\
\
"market\_rules\_link": "https://data.forecastex.com/regulatory/GPTermsandConditions.pdf",\
\
"release\_time": 1781301540,\
\
"payout\_time": 1781373600,\
\
"payout": "$1.00",\
\
"price\_increment": "$0.01",\
\
"exchange\_timezone": "US/Central"\
\
}\
\
{ "asset\_class": "OPT", "description": "The Georgia Democratic Gubernatorial Primary determines the party nominee for governor, shaping state leadership and national political influence.", "market\_name": "Georgia Governor Democratic Primary", "measured\_period": "May19'26", "threshold": "Stacey Abrams", "source\_agency": "Georgia Secretary of State Elections Division", "data\_and\_resolution\_link": "https://sos.ga.gov/index.php/elections", "last\_trade\_time": 1781301540, "product\_code": "GPGAD", "market\_rules\_link": "https://data.forecastex.com/regulatory/GPTermsandConditions.pdf", "release\_time": 1781301540, "payout\_time": 1781373600, "payout": "$1.00", "price\_increment": "$0.01", "exchange\_timezone": "US/Central" }\
\
{\
    "asset\_class": "OPT",\
    "description": "The Georgia Democratic Gubernatorial Primary determines the party nominee for governor, shaping state leadership and national political influence.",\
...
print(response.text)\
\
import requests url = "{{base-url}}/forecast/contract/schedules?conid=767285167" payload = {} headers = {} response = requests.request("GET", url, headers=headers, data=payload) print(response.text)\
\
import requests\
\
url = "{{base-url}}/forecast/contract/schedules?conid=767285167"\
...
\
{ "timezone": "US/Central", "trading\_schedules": \[ { "day\_of\_week": "Saturday", "trading\_times": \[ { "open": "12:00 AM", "close": "4:15 PM" }, { "open": "4:16 PM", "close": "11:59 PM" } \] }, { "day\_of\_week": "Sunday", "trading\_times": \[ { "open": "12:00 AM", "close": "4:15 PM" }, { "open": "4:16 PM", "close": "11:59 PM" } \] }, }\
\
{\
    "timezone": "US/Central",\
    "trading\_schedules": \[\
...
print(response.text)\
\
import requests url = "{{base-url}}/forecast/contract/details?conid=767285167" payload = {} headers = {} response = requests.request("GET", url, headers=headers, data=payload) print(response.text)\
\
import requests\
\
url = "{{base-url}}/forecast/contract/details?conid=767285167"\
...
\
{ "conid\_yes": 767285167, "conid\_no": 767285169, "question": "Will Stacey Abrams win the Georgia Democratic primary for governor in 2026?", "side": "Y", "strike\_label": "Stacey Abrams", "strike": 1.0, "exchange": "FORECASTX", "expiration": "20260612", "symbol": "GPGAD", "category": "g7428", "logo\_category": "g17467", "measured\_period": "May19'26", "market\_name": "Georgia Governor Democratic Primary", "underlying\_conid": 766914406, "payout": 1.0 }\
\
{\
    "conid\_yes": 767285167,\
    "conid\_no": 767285169,\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/allocation/accounts"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/accounts" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/accounts" \
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/accounts \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/accounts \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group" \
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/group \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/group \\\
--request GET\
...
{\
\
"allocation\_method": "N",\
\
"size": 10,\
\
"name": "Group\_1\_NetLiq"\
\
}\
\
\]\
...
\
{ "data": \[ { "allocation\_method": "N", "size": 10, "name": "Group\_1\_NetLiq" } \] }\
\
{\
  "data": \[\
    {\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group/single"\
\
json\_content ={\
\
"name":"Group\_1\_NetLiq"\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group/single" json\_content ={ "name":"Group\_1\_NetLiq" } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group/single" \
json\_content ={\
  "name":"Group\_1\_NetLiq"\
...
\--header 'Content-Type:application/json' \\\
\
\--data '{"name":"Group\_1\_NetLiq"}'\
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/group/single \\ --request POST --header 'Content-Type:application/json' \\ --data '{"name":"Group\_1\_NetLiq"}'\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/group/single \\\
--request POST\
...
\
{ "name": "Group\_1\_NetLiq", "accounts": \[ { "amount": 1, "name": "DU1234567" }, { "amount": 5, "name": "DU9876543" } \], "default\_method": "R" }\
\
{\
  "name": "Group\_1\_NetLiq",\
  "accounts": \[\
...
requests.post(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group" json\_content = { "name":"Group\_1\_NetLiq", "accounts":\[{ "name":"U1234567", "amount":10 },{ "name":"U2345678", "amount":5 }\], "default\_method":"N" } requests.post(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group"\
json\_content = {\
  "name":"Group\_1\_NetLiq",\
...
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/group \\ --request POST --header 'Content-Type:application/json' \\ --data '{ "name":"Group\_1\_NetLiq", "accounts":\[{ "name":"U1234567", "amount":10 },{ "name":"U2345678", "amount":5 }\], "default\_method":"N" }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/group \\\
--request POST\
...
\
requests.put(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group" json\_content = { "name":"Group\_1\_NetLiq", "accounts":\[{ "name":"U1234567", "amount":15 },{ "name":"U2345678", "amount":10 }\], "default\_method":"N" } requests.put(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group"\
json\_content = {\
  "name":"Group\_1\_NetLiq",\
...
\--data '{\
\
"name":"new\_test\_group",\
\
"prev\_name":"Group\_1\_NetLiq",\
\
"accounts":\[{\
\
"name":"U1234567",\
...
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/group \\ --request PUT --header 'Content-Type:application/json' \\ --data '{ "name":"new\_test\_group", "prev\_name":"Group\_1\_NetLiq", "accounts":\[{ "name":"U1234567", "amount":10 },{ "name":"U2345678", "amount":5 }\], "default\_method":"A" }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/group \\\
--request PUT\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group/delete"\
\
json\_content = {\
\
"name":"Group\_1\_NetLiq",\
...
requests.post(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group/delete" json\_content = { "name":"Group\_1\_NetLiq", } requests.post(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/iserver/account/allocation/group/delete"\
json\_content = {\
  "name":"Group\_1\_NetLiq",\
...
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/group/delete \\ --request POST --header 'Content-Type:application/json' \\ --data '{ "name":"Group\_1\_NetLiq", }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/group/delete \\\
--request POST\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/marketdata/unsubscribeall"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/marketdata/unsubscribeall" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/marketdata/unsubscribeall"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/presets \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/presets \\\
--request GET\
...
{\
\
"group\_auto\_close\_positions": false,\
\
"default\_method\_for\_all": "N",\
\
"profiles\_auto\_close\_positions": false,\
\
"strict\_credit\_check": false,\
\
"group\_proportional\_allocation": false\
\
}\
\
{ "group\_auto\_close\_positions": false, "default\_method\_for\_all": "N", "profiles\_auto\_close\_positions": false, "strict\_credit\_check": false, "group\_proportional\_allocation": false }\
\
{\
  "group\_auto\_close\_positions": false,\
  "default\_method\_for\_all": "N",\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/allocation/presets"\
\
json\_content = {\
\
"default\_method\_for\_all": "E",\
\
"group\_auto\_close\_positions": true,\
\
"profiles\_auto\_close\_positions": true,\
\
"strict\_credit\_check": false,\
\
"group\_proportional\_allocation": false\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/presets" json\_content = { "default\_method\_for\_all": "E", "group\_auto\_close\_positions": true, "profiles\_auto\_close\_positions": true, "strict\_credit\_check": false, "group\_proportional\_allocation": false } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/allocation/presets" \
json\_content = {\
  "default\_method\_for\_all": "E",\
...
\
curl \\ --url {{baseUrl}}/iserver/account/allocation/presets \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "default\_method\_for\_all": "E", "group\_auto\_close\_positions": true, "profiles\_auto\_close\_positions": true, "strict\_credit\_check": false, "group\_proportional\_allocation": false }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/allocation/presets \\\
--request POST \\\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/unreadnumber"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/unreadnumber" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/unreadnumber"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/fyi/unreadnumber \\ --request GET\
\
curl \\\
--url {{baseUrl}}/fyi/unreadnumber \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/settings"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/settings" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/settings"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/fyi/settings \\ --request GET\
\
curl \\\
--url {{baseUrl}}/fyi/settings \\\
--request GET\
...
See [Typecode](./cpapi-v1.md#fyi-typecode)\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/settings/SM"\
\
json\_content ={"enabled":true}\
\
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/settings/SM" json\_content ={"enabled":true} requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/settings/SM"\
json\_content ={"enabled":true}\
requests.post(url=request\_url, json=json\_content)\
...
\--data '{"enabled":true}'\
\
curl \\ --url {{baseUrl}}/fyi/settings/SM \\ --request POST \\ --data '{"enabled":true}'\
\
curl \\\
--url {{baseUrl}}/fyi/settings/SM \\\
--request POST \\\
...
**typecode:** String. Required  \
Code used to signify a specific type of FYI template.  \
See [FYI Typecodes](./cpapi-v1.md#fyi-typecode)\
 section for more details.\
\
*   Python\
*   cURL\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/disclaimer/SM"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/disclaimer/SM" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/disclaimer/SM"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/fyi/disclaimer/SM\\ --request GET\
\
curl \\\
--url {{baseUrl}}/fyi/disclaimer/SM\\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/disclaimer/CT"\
\
json\_content = {}\
\
requests.put(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/fyi/disclaimer/CT" json\_content = {} requests.put(url=request\_url, json=json\_content\
\
request\_url = f"{baseUrl}/fyi/disclaimer/CT"\
json\_content = {}\
requests.put(url=request\_url, json=json\_content\
...
\--data ''\
\
curl \\ --url {{baseUrl}}/fyi/disclaimer/CT \\ --request PUT \\ --data ''\
\
curl \\\
--url {{baseUrl}}/fyi/disclaimer/CT \\\
--request PUT \\\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/fyi/deliveryoptions \\ --request GET\
\
curl \\\
--url {{baseUrl}}/fyi/deliveryoptions \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/device"\
\
json\_content = {\
\
"deviceName": "iPhone",\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/device" json\_content = { "deviceName": "iPhone", "deviceId": "apn://mtws@1234E5E67D8A9012EC3E45D6E7D89A01F2345CDBBB678B9BE0FB12345AF6D789", "uiName": "apn://mtws@1234E5E67D8A9012EC3E45D6E7D89A01F2345CDBBB678B9BE0FB12345AF6D789", "enabled": True } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/device"\
json\_content = {\
    "deviceName": "iPhone",\
...
\
curl \\ --url {{baseUrl}}/fyi/deliveryoptions/device \\ --request POST \\ --data '{ "deviceName": "iPhone", "deviceId": "apn://mtws@1234E5E67D8A9012EC3E45D6E7D89A01F2345CDBBB678B9BE0FB12345AF6D789", "uiName": "apn://mtws@1234E5E67D8A9012EC3E45D6E7D89A01F2345CDBBB678B9BE0FB12345AF6D789", "enabled": True }'\
\
curl \\\
--url {{baseUrl}}/fyi/deliveryoptions/device \\\
--request POST \\\
...
Can be retrieved from [/fyi/deliveryoptions](./cpapi-v1.md#get-delivery)\
.\
\
*   Python\
*   cURL\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/1"\
\
requests.delete(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/1" requests.delete(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/1" \
requests.delete(url=request\_url)\
\
...
\--request DELETE\
\
curl \\ --url {{baseUrl}}/fyi/deliveryoptions/1 \\ --request DELETE\
\
curl \\\
--url {{baseUrl}}/fyi/deliveryoptions/1 \\ \
--request DELETE\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/email?enabled=true"\
\
json\_content = {}\
\
requests.put(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/email?enabled=true" json\_content = {} requests.put(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/deliveryoptions/email?enabled=true"\
json\_content = {}\
requests.put(url=request\_url, json=json\_content)\
...
\--data ""\
\
curl \\ --url {{baseUrl}}/fyi/deliveryoptions/email?enabled={{ enabled }} \\ --request PUT \\ --data ""\
\
curl \\\
--url {{baseUrl}}/fyi/deliveryoptions/email?enabled={{ enabled }} \\\
--request PUT \\\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/notifications?max=10"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/notifications?max=10" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/fyi/notifications?max=10" \
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/fyi/notifications?max=10 \\ --request GET\
\
curl \\\
--url {{baseUrl}}/fyi/notifications?max=10 \\ \
--request GET\
...
\
\[{ "R": 0, "D": "1702469440.0", "MS": "IBKR FYI: Option Expiration Notification", "MD": "One or more option contracts in your portfolio are set to expire shortly. <br> - QQQ 15DEC2023 385 P in Account(Qty): U\*\*\*\*7890(6) <br> - QQQ 15DEC2023 387 P in Account(Qty): D\*\*\*\*0685(-6) <br> <br>Please use the Option Rollover tool to roll existing contracts into contracts with an expiration, strike and price condition of your preference.", "ID": "2023121370119463", "HT": 0, "FC": "OE" }\]\
\
\[{\
  "R": 0,\
  "D": "1702469440.0",\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/fyi/notifications/more?id=12345678901234567"\
\
json\_content = {}\
\
requests.put(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/notifications/more?id=12345678901234567" json\_content = {} requests.put(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/fyi/notifications/more?id=12345678901234567"\
json\_content = {}\
requests.put(url=request\_url, json=json\_content)\
...
\--data ""\
\
curl \\ --url {{baseUrl}}/fyi/notifications/12345678901234567 \\ --request PUT \\ --data ""\
\
curl \\\
--url {{baseUrl}}/fyi/notifications/12345678901234567 \\\
--request PUT \\\
...
\
### Event contract category and market tree\
\
\
...
See [Market Data Fields](./cpapi-v1.md#market-data-fields)\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/marketdata/snapshot?conids=265598,8314&fields=31,84,86"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/marketdata/snapshot?conids=265598,8314&fields=31,84,86" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/marketdata/snapshot?conids=265598,8314&fields=31,84,86"\
requests.get(url=request\_url)\
\
...
\
**6509:** String.  \
Returns a multi-character value representing the [Market Data Availability.](./cpapi-v1.md#md-availability)\
\
Plain text\
\
Copy to clipboard\
...
\]\
\
\[ { "\_updated": 1702334859712, "conidEx": "265598", "conid": 265598, "server\_id": "q1", "6119": "serverId", "31": "193.18", "84": "193.06", "86":"193.14", "6509": "RpB" } \]\
\
\[\
  {\
    "\_updated": 1702334859712,\
...
\
Please keep in mind that the Web API still retains a standard pacing limit of 10 requests per second. For more frequency returns, implement the [smd websocket topic](./cpapi-v1.md#ws-sub-watchlist-data)\
 in place of the HTML endpoint.\
\
| Product | Frequency |\
| --- | --- |\
| All Products | 500ms |\
...
\
See [here](../general/market-data-subscriptions.md#reg-snapshot)\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/md/regsnapshot?conid=265598"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/md/regsnapshot?conid=265598" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/md/regsnapshot?conid=265598"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/md/regsnapshot?conid=265598 \\ --request GET\
\
curl \\\
--url {{baseUrl}}/md/regsnapshot?conid=265598 \\\
--request GET\
...
#### Response Object\
\
**Note:** The integer fields returned below also correspond to the [Market Data Field](./cpapi-v1.md#market-data-fields)\
 values used for the standard /iserver/marketdata/snapshot endpoint.\
\
**conid:** int.  \
Returns the contract ID of the request.\
\
...
\
{ "conid": conid, "conidEx": "conidEx", "BboExchange": "BboExchange", "HasDelayed": HasDelayed, "84": "Bid", "86": "Ask", "88": Bid\_Size, "85": Ask\_Size, "BestBidExch": BestBidExch, "BestAskExch": BestAskExch, "31": "Last", "7059": Last\_Size, "LastExch": LastExch, "7057": "Ask Exch", "7068": "Bid Exch", "7058": "Last\_Exch" }\
\
{\
  "conid": conid,\
  "conidEx": "conidEx",\
...
| O   | Incomplete Market Data API Acknowledgement | The annual Market Data API Acknowledgement has not been completed for the given user. To complete the agreement:<br><br>1.  Log in to the<br>2.  Select “Welcome” in the top right corner, and then “Settings”<br>3.  You will find a large button for “Market Data Subscriptions” on the right.<br>4.  Find the “Market Data API Agreement” on the right. |\
...
\
\
*   Historical data is filtered by default. See our FAQ for more insight, [here](https://www.interactivebrokers.com/lib/cstools/faq/#/content/102546341)\
    .\
...
See _Step Size_ below to ensure your Bar Size is supported for your chosen Period value.\
\
**startTime:** String  \
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/marketdata/history?conid=265598&exchange=SMART&period=1d&bar=1d&startTime=20230821-13:30:00&outsideRth=true&source=Midpoint"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/marketdata/history?conid=265598&exchange=SMART&period=1d&bar=1d&startTime=20230821-13:30:00&outsideRth=true&source=Midpoint" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/marketdata/history?conid=265598&exchange=SMART&period=1d&bar=1d&startTime=20230821-13:30:00&outsideRth=true&source=Midpoint"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/marketdata/history?conid=265598&exchange=SMART&period=1d&bar=1h&startTime=20230821-13:30:00&outsideRth=true \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/marketdata/history?conid=265598&exchange=SMART&period=1d&bar=1h&startTime=20230821-13:30:00&outsideRth=true \\ \
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/marketdata/unsubscribe"\
\
json\_content ={\
\
"conid":265598\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/marketdata/unsubscribe" json\_content ={ "conid":265598 } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/marketdata/unsubscribe" \
json\_content ={\
  "conid":265598 \
...
\
curl \\ --url {{baseUrl}}/iserver/marketdata/unsubscribe \\ --request POST --data '{ "conid":265598 }'\
\
curl \\\
--url {{baseUrl}}/iserver/marketdata/unsubscribe \\ \
--request POST\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/marketdata/unsubscribeall \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/marketdata/unsubscribeall \\ \
--request GET\
...
\
\
To begin, users must first make a call to the [/iserver/secdef/search endpoint](./cpapi-v1.md#search-symbol-contract)\
 for the underlying symbol. This is required for all future steps every time the user does not know the final derivative’s conId.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/secdef/search?symbol=SPX"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/secdef/search?symbol=SPX" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/secdef/search?symbol=SPX"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl --insecure \\ --url https://localhost:5000/v1/api/iserver/secdef/search?symbol=SPX \\ --request GET\
\
curl --insecure \\\
--url https://localhost:5000/v1/api/iserver/secdef/search?symbol=SPX \\\
--request GET\
...
\]\
\
\[ { "conid": "416904", "companyHeader": "S&P 500 Stock Index - CBOE", "companyName": "S&P 500 Stock Index", "symbol": "SPX", "description": "CBOE", "restricted": "IND", "sections": \[ {...}, { "secType": "OPT", "months": "JAN24;FEB24;MAR24;APR24;MAY24;JUN24;JUL24;AUG24;SEP24;OCT24;NOV24;DEC24;JAN25;MAR25;JUN25;DEC25;DEC26;DEC27;DEC28;DEC29", "exchange": "SMART;CBOE;IBUSOPT" }, {...} \] } \]\
\
\[\
  {\
    "conid": "416904",\
...
\
\
After querying the /iserver/secdef/search endpoint, developers should now call the [/iserver/secdef/strikes endpoint](./cpapi-v1.md#strike-conid-contract)\
. To receive the appropriate strikes, the conId, secType, and expiration month should be specified.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/secdef/strikes?conid=416904&sectype=OPT&month=JAN25"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/secdef/strikes?conid=416904&sectype=OPT&month=JAN25" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/secdef/strikes?conid=416904&sectype=OPT&month=JAN25"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/secdef/strikes?conid=416904&secType=OPT&month=JAN25 \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/secdef/strikes?conid=416904&secType=OPT&month=JAN25 \\\
--request GET\
...
\
\
After calling the /search and /strikes endpoints, users can use the [/iserver/secdef/info endpoint](./cpapi-v1.md#secdef-info-contract)\
 to validate the derivative conId. This endpoint should be called for each strike and right combination of interest.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/secdef/info?conid=416904&secType=OPT&month=JAN25&strike=3975&right=P\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/secdef/info?conid=416904&secType=OPT&month=JAN25&strike=3975&right=P requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/secdef/info?conid=416904&secType=OPT&month=JAN25&strike=3975&right=P\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/secdef/info?conid=416904&secType=OPT&month=JAN25&strike=3975&right=P \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/secdef/info?conid=416904&secType=OPT&month=JAN25&strike=3975&right=P \\\
--request GET\
...
\
\
After confirming all of our interested strikes to retrieve our conIds, we officially have our option chain established. From there, users may be interested to send requests to the [/iserver/marketdata/snapshot endpoint](./cpapi-v1.md#md-snapshot)\
 in bulk by comma separating the “conids” list.\
\
Alternatively, users that already are aware of the market data potentially through other means can look to start placing orders using the [/iserver/account/{accountId}/orders endpoint](./cpapi-v1.md#place-order)\
.\
\
### Order Monitoring\
\
...
\
To retrieve order information for a specific account, clients must first query the [/iserver/account endpoint](./cpapi-v1.md#switch-account)\
 to switch to the appropriate account.\
\
Please be aware that filtering orders using the /iserver/account/orders endpoint will prevent order details from coming through over the [websocket “sor” topic](./cpapi-v1.md#ws-order-updates-sub)\
. To resolve this issue, developers should set “force=true” in a follow-up /iserver/account/orders call to clear any cached behavior surrounding the endpoint prior to calling for the websocket request.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/orders?filters=filled&force=true"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/orders?filters=filled&force=true" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/orders?filters=filled&force=true"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/account/orders?filters=filled&force=true \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/account/orders?filters=filled&force=true \\\
--request GET\
...
"timeInForce": "GTC",\
\
"lastExecutionTime\_r": 1702317649000,\
\
"side": "SELL"\
\
}\
...
\
{ "orders": \[ { "acct": "U1234567", "conidex": "265598", "conid": 265598, "account": "U1234567", "orderId": 1234568790, "cashCcy": "USD", "sizeAndFills": "5", "orderDesc": "Sold 5 Market, GTC", "description1": "AAPL", "ticker": "AAPL", "secType": "STK", "listingExchange": "NASDAQ.NMS", "remainingQuantity": 0.0, "filledQuantity": 5.0, "totalSize": 5.0, "companyName": "APPLE INC", "status": "Filled", "order\_ccp\_status": "Filled", "avgPrice": "192.26", "origOrderType": "MARKET", "supportsTaxOpt": "1", "lastExecutionTime": "231211180049", "orderType": "Market", "bgColor": "#FFFFFF", "fgColor": "#000000", "order\_ref": "Order123", "timeInForce": "GTC", "lastExecutionTime\_r": 1702317649000, "side": "SELL" } \], "snapshot": true }\
\
{\
  "orders": \[\
    {\
...
Important Notes:\
\
*   For multi-account structures such as Financial Advisors or linked-account structures, users must call [/iserver/account](./cpapi-v1.md#switch-account)\
     to switch to the affiliated account before requesting order status. It is otherwise expected to result in a ‘503’ error.\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/order/status/1234567890"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/order/status/1234567890" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/order/status/1234567890"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/account/order/status/1234567890\\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/account/order/status/1234567890\\\
--request GET\
...
\
{ "sub\_type": null, "request\_id": "209", "server\_id": "0", "order\_id": 1799796559, "conidex": "265598", "conid": 265598, "symbol": "AAPL", "side": "S", "contract\_description\_1": "AAPL", "listing\_exchange": "NASDAQ.NMS", "option\_acct": "c", "company\_name": "APPLE INC", "size": "0.0", "total\_size": "5.0", "currency": "USD", "account": "U1234567", "order\_type": "MARKET", "cum\_fill": "5.0", "order\_status": "Filled", "order\_ccp\_status": "2", "order\_status\_description": "Order Filled", "tif": "DAY", "fg\_color": "#FFFFFF", "bg\_color": "#000000", "order\_not\_editable": true, "editable\_fields":"", "cannot\_cancel\_order": true, "deactivate\_order": false, "sec\_type": "STK", "available\_chart\_periods": "#R|1", "order\_description": "Sold 5 Market, Day", "order\_description\_with\_contract": "Sold 5 AAPL Market, Day", "alert\_active": 1, "child\_order\_type": "0", "order\_clearing\_account": "U1234567", "size\_and\_fills": "5", "exit\_strategy\_display\_price": "193.12", "exit\_strategy\_chart\_description": "Sold 5 @ 192.26", "average\_price": "192.26", "exit\_strategy\_tool\_availability": "1", "allowed\_duplicate\_opposite": true, "order\_time": "231211180049" }\
\
{\
  "sub\_type": null,\
  "request\_id": "209",\
...
\
The values returned from the “order\_status” field of our Live Orders object will vary slightly from the format used while using the “filters” parameter from [GET /iserver/account/orders](./cpapi-v1.md#live-orders)\
.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/trades?days=3"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/trades?days=3" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/iserver/account/trades?days=3"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/iserver/account/trades?days=3 \\ --request GET\
\
curl \\\
--url {{baseUrl}}/iserver/account/trades?days=3 \\\
--request GET\
...
{\
\
"execution\_id": "0000e0d5.6576fd38.01.01",\
\
"symbol": "AAPL",\
\
"supports\_tax\_opt": "1",\
\
"side": "S",\
\
"order\_description": "Sold 5 @ 192.26 on ISLAND",\
\
"trade\_time": "20231211-18:00:49",\
\
"trade\_time\_r": 1702317649000,\
\
"size": 5.0,\
\
"price": "192.26",\
...
\
"account\_allocation\_name": "U1234567",\
\
"company\_name": "APPLE INC",\
\
"contract\_description\_1": "AAPL",\
...
"clearing\_name": "IB",\
\
"liquidation\_trade": "0",\
\
"is\_event\_trading": "0"\
\
}\
\
\]\
\
\[ { "execution\_id": "0000e0d5.6576fd38.01.01", "symbol": "AAPL", "supports\_tax\_opt": "1", "side": "S", "order\_description": "Sold 5 @ 192.26 on ISLAND", "trade\_time": "20231211-18:00:49", "trade\_time\_r": 1702317649000, "size": 5.0, "price": "192.26", "order\_ref": "Order123", "submitter": "user1234", "exchange": "ISLAND", "commission": "1.01", "net\_amount": 961.3, "account": "U1234567", "accountCode": "U1234567", "account\_allocation\_name": "U1234567", "company\_name": "APPLE INC", "contract\_description\_1": "AAPL", "sec\_type": "STK", "listing\_exchange": "NASDAQ.NMS", "conid": 265598, "conidEx": "265598", "clearing\_id": "IB", "clearing\_name": "IB", "liquidation\_trade": "0", "is\_event\_trading": "0" } \]\
\
\[\
  {\
    "execution\_id": "0000e0d5.6576fd38.01.01",\
...
\
CP WEB API supports various advanced orderTypes, for additional details and examples refer to the [Order Types](../general/order-types.md)\
 page.\
\
...
Note: See [Cash Quantity Orders in the Web API](./cpapi-v1.md#cash-qty)\
 for more details.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/orders"\
\
json\_content = {\
\
"orders": \[\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/orders" json\_content = { "orders": \[ { "acctId": "U1234567", "conid": 265598, "conidex": "265598@SMART", "manualIndicator": True, "extOperator":"person1234", "secType": "265598@STK", "cOID": "AAPL-BUY-100", "parentId": None, "orderType": "TRAILLMT", "listingExchange": "NASDAQ", "isSingleGroup": false, "outsideRTH": true, "price": 185.50, "auxPrice": 183, "side": "BUY", "ticker": "AAPL", "tif": "GTC", "trailingAmt": 1.00, "trailingType": "amt", "referrer": "QuickTrade", "quantity": 100, # Can not be used in tandem with quantity value. # "cashQty": {{ cashQty }}, # "fxQty": {{ fxQty }}, "useAdaptive": false, "isCcyConv": false, # May specify an allocation method such as Equal or NetLiq for Financial Advisors. # "allocationMethod": {{ allocationMethod }}, "strategy": "Vwap", "strategyParameters": { "MaxPctVol":"0.1", "StartTime":"14:00:00 EST", "EndTime":"15:00:00 EST", "AllowPastEndTime":true } } \] } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/orders"\
json\_content = {\
  "orders": \[\
...
\
curl \\ --url {{baseUrl}}/iserver/account/U1234567/orders \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "orders": \[ { "acctId": "U1234567", "conid": 265598, "conidex": "265598@SMART", "manualIndicator": true, "extOperator":"person1234", "secType": "265598:STK", "cOID": "AAPL-BUY-100", "parentId": null, "orderType": "TRAILLMT", "listingExchange": "ISLAND", "isSingleGroup": false, "outsideRth": true, "price": 185.50, "auxPrice": 183, "side": "BUY", "ticker": "AAPL", "tif": "GTC", "trailingAmt": 1.00, "trailingType": "amt", "referrer": "QuickTrade", "quantity": 100, # Can not be used in tandem with quantity value. # "cashQty": {{ cashQty }}, # "fxQty": {{ fxQty }}, "useAdaptive": false, "isCcyConv": false, # May specify an allocation method such as Equal or NetLiq for Financial Advisors. # "allocationMethod": {{ allocationMethod }}, "strategy": "Vwap", "strategyParameters": { "MaxPctVol":"0.1", "StartTime":"14:00:00 EST", "EndTime":"15:00:00 EST", "AllowPastEndTime":true } } \] }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/U1234567/orders \\\
--request POST \\\
...
See [Order Status Value](./cpapi-v1.md#order-status-value)\
 for more information.\
\
...
\]\
\
\[ { "order\_id": "1234567890", "order\_status": "Submitted", "encrypt\_message": "1" } \]\
\
\[\
  {\
    "order\_id": "1234567890",\
...
\
See the [Place Order Reply](./cpapi-v1.md#place-order-reply)\
 section for more details on resolving the confirmation.\
\
Users that wish to avoid receiving /reply message should consider using the [Suppression](./cpapi-v1.md#questions-suppress)\
 endpoint to automatically accept them.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/reply/a12b34c5-d678-9e012f-3456-7a890b12cd3e"\
\
json\_content = {"confirmed":true}\
\
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/reply/a12b34c5-d678-9e012f-3456-7a890b12cd3e" json\_content = {"confirmed":true} requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/reply/a12b34c5-d678-9e012f-3456-7a890b12cd3e"\
json\_content = {"confirmed":true}\
requests.post(url=request\_url, json=json\_content)\
...
\--data '{"confirmed":true}'\
\
curl \\ --url {{baseUrl}}/iserver/reply/a12b34c5-d678-9e012f-3456-7a890b12cd3e \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{"confirmed":true}'\
\
curl \\\
--url {{baseUrl}}/iserver/reply/a12b34c5-d678-9e012f-3456-7a890b12cd3e \\\
--request POST \\\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/notification"\
\
json\_content = {\
\
"orderId": 987654321,\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/notification" json\_content = { "orderId": 987654321, "reqId": "12345", "text": "Yes" } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/notification"\
json\_content = {\
  "orderId": 987654321,\
...
\
curl \\ --url {baseUrl}/iserver/notification \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "orderId": 987654321, "reqId": "12345", "text": "Yes" }'\
\
curl \\\
--url {baseUrl}/iserver/notification \\\
--request POST \\\
...
\
**Note:** Please be aware that /whatif orders are also effected by our [message suppression endpoint](./cpapi-v1.md#questions-suppress)\
.\
\
Clients must query [/iserver/marketdata/snapshot](./cpapi-v1.md#md-snapshot)\
 for the instrument prior to requesting the /whatif endpoint.\
\
...
\
See the [Place Order](./cpapi-v1.md#place-order)\
 section for more details.\
\
*   Python\
*   cURL\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/orders/whatif"\
\
json\_content = {\
\
"orders": \[\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/orders/whatif" json\_content = { "orders": \[ { "conid": 265598, "orderType": "LMT", "price": 200.25, "side": "BUY", "tif": "DAY", "quantity": 5 } \] } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/orders/whatif"\
json\_content = {\
  "orders": \[\
...
\
curl \\ --url {{baseUrl}}/iserver/account/U1234567/orders/whatif \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "orders": \[ { "conid": 265598, "orderType": "LMT", "price": 200.25, "side": "BUY", "tif": "DAY", "quantity": 5 } \] }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/U1234567/orders/whatif \\\
--request POST \\\
...
\
\
Trading with the WebAPI allows users to submit orders in the [OVERNIGHT market](https://www.interactivebrokers.com/en/trading/us-overnight-trading.php)\
 using both OVERNIGHT exclusive orders as well as OVERNIGHT+DAY orders. This is handled by submitting the affiliated Time-In-Force value when [Placing an Order](./cpapi-v1.md#place-order)\
.\
\
#### Overnight\
\
...
\
An OCA group will follow this same structure. However, in addition to the standard bracket, each order will include\
\
"isSingleGroup": true\
\
`"isSingleGroup": true`. Otherwise, no additional modifications need to be made.\
\
Plain text\
\
Copy to clipboard\
...
\--request DELETE\
\
curl \\ --url {{baseUrl}}/iserver/account/U1234567/order/123456789?manualIndicator=true&extOperator=person1234 \\ --request DELETE\
\
curl \\\
--url {{baseUrl}}/iserver/account/U1234567/order/123456789?manualIndicator=true&extOperator=person1234 \\\
--request DELETE\
...
\
{ "msg": "Request was submitted", "order\_id": 123456789, "conid": 265598, "account": "U1234567" }\
\
{\
    "msg": "Request was submitted",\
    "order\_id": 123456789,\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/order/123456789\
\
json\_content = {\
\
"conid": 265598,\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/order/123456789 json\_content = { "conid": 265598, "orderType": "STP", "price": 180, "side": "BUY", "tif": "DAY", "quantity": 10, "manualIndicator":True, "extOperator": "person1234" } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/account/U1234567/order/123456789\
json\_content = {\
  "conid": 265598,\
...
\
curl \\ --url {{baseUrl}}/iserver/account/U1234567/order/123456789 \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "conid": 265598, "orderType": "STP", "price": 180, "side": "BUY", "tif": "DAY", "quantity": 10, "manualIndicator":true, "extOperator": "person1234" }'\
\
curl \\\
--url {{baseUrl}}/iserver/account/U1234567/order/123456789 \\\
--request POST \\\
...
The only supported message IDs are listed in our [Suppressible Message IDs](./cpapi-v1.md#suppressible-id)\
 list. However, users should look to suppress messages on an as-needed basis to avoid unexpected order submissions.\
\
*   Python\
*   cURL\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/questions/suppress"\
\
json\_content = {\
\
"messageIds": \["o102"\]\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/questions/suppress" json\_content = { "messageIds": \["o102"\] } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/questions/suppress"\
json\_content = {\
  "messageIds": \["o102"\]\
...
\
curl \\ --url {{baseUrl}}/iserver/questions/suppress \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "messageIds": \["o102"\] }'\
\
curl \\\
--url {{baseUrl}}/iserver/questions/suppress \\\
--request POST \\\
...
| o10336 | This security has limited liquidity. If you choose to trade this security, there is a heightened risk that you may not be able to close your position at the time you wish, at a price you wish, and/or without incurring a loss. Confirm that you understand the risks of trading illiquid securities.  <br>Are you sure you want to submit this order? |\
...
\
\
Resets all messages disabled by the [Suppress Messages endpoint](./cpapi-v1.md#questions-suppress)\
.\
\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/iserver/questions/suppress/reset"\
\
json\_content = {}\
\
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/questions/suppress/reset" json\_content = {} requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/iserver/questions/suppress/reset"\
json\_content = {}\
requests.post(url=request\_url, json=json\_content)\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/accounts"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/accounts" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/accounts"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/accounts \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/accounts \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/subaccounts"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/subaccounts" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/subaccounts"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/subaccounts \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/subaccounts \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/subaccounts2?page=0"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/subaccounts2?page=0" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/subaccounts2?page=0"\
requests.get(url=request\_url) \
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/subaccounts2?page=0 \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/subaccounts2?page=0 \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/U1234567/meta"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/meta" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/meta"\
requests.get(url=request\_url) \
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/U1234567/meta \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/U1234567/meta \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/U1234567/allocation"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/allocation" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/allocation"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/U1234567/allocation \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/U1234567/allocation \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/U1234567/combo/positions?nocache=true"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/combo/positions?nocache=true" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/combo/positions?nocache=true"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/U1234567/combo/positions?nocache=true \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/U1234567/combo/positions?nocache=true \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/allocation"\
\
json\_content = {\
\
"acctIds": \[\
...
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/portfolio/allocation" json\_content = { "acctIds": \[ "U1234567", "U4567890" \] } requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/portfolio/allocation"\
json\_content = {\
  "acctIds": \[\
...
\
curl \\ --url {{baseUrl}}/portfolio/allocation \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "acctIds": \[ "U1234567", "U4567890" \] }'\
\
curl \\\
--url {{baseUrl}}/portfolio/allocation \\\
--request POST \\\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/U1234567/positions/0?direction=a&period=1W&sort=position&model=MyModel"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/positions/0?direction=a&period=1W&sort=position&model=MyModel" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/positions/0?direction=a&period=1W&sort=position&model=MyModel"\
requests.get(url=request\_url) \
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/U1234567/positions/0?direction=a&period=1W&sort=position&model=MyModel \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/U1234567/positions/0?direction=a&period=1W&sort=position&model=MyModel \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio2/U1234567/positions?direction=a&sort=position"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio2/U1234567/positions?direction=a&sort=position" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio2/U1234567/positions?direction=a&sort=position"\
requests.get(url=request\_url) \
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio2/U1234567/positions?direction=a&sort=position \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio2/U1234567/positions?direction=a&sort=position \\\
--request GET\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/U1234567/position/265598"\
\
requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/position/265598" requests.get(url=request\_url)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/position/265598"\
requests.get(url=request\_url)\
\
...
\--request GET\
\
curl \\ --url {{baseUrl}}/portfolio/U1234567/position/265598 \\ --request GET\
\
curl \\\
--url {{baseUrl}}/portfolio/U1234567/position/265598 \\\
--request GET\
...
\]\
\
\[ { "acctId": "U1234567", "conid": 265598, "contractDesc": "AAPL", "position": 614.2639, "mktPrice": 197.3840027, "mktValue": 121245.87, "currency": "USD", "avgCost": 192.7477563, "avgPrice": 192.7477563, "realizedPnl": 0.0, "unrealizedPnl": 2847.88, "exchs": null, "expiry": null, "putOrCall": null, "multiplier": 0.0, "strike": "0", "exerciseStyle": null, "conExchMap": \[\], "assetClass": "STK", "undConid": 0, "model": "", "time": 43, "chineseName": "苹果公司", "allExchanges": "AMEX,NYSE,CBOE,PHLX,CHX,ARCA,ISLAND,ISE,IDEAL,NASDAQQ,NASDAQ,DRCTEDGE,BEX,BATS,NITEECN,EDGEA,CSFBALGO,JEFFALGO,NYSENASD,PSX,BYX,ITG,PDQ,IBKRATS,CITADEL,NYSEDARK,MIAX,IBDARK,CITADELDP,NASDDARK,IEX,WEDBUSH,SUMMER,WINSLOW,FINRA,LIQITG,UBSDARK,BTIG,VIRTU,JEFF,OPCO,COWEN,DBK,JPMC,EDGX,JANE,NEEDHAM,FRACSHARE,RBCALGO,VIRTUDP,BAYCREST,FOXRIVER,MND,NITEEXST,PEARL,GSDARK,NITERTL,NYSENAT,IEXMID,HRT,FLOWTRADE,HRTDP,JANELP,PEAK6,IMCDP,CTDLZERO,HRTMID,JANEZERO,HRTEXST,IMCLP,LTSE,SOCGENDP,MEMX,INTELCROS,VIRTUBYIN,JUMPTRADE,NITEZERO,TPLUS1,XTXEXST,XTXDP,XTXMID,COWENLP,BARCDP,JUMPLP,OLDMCLP,RBCCMALP,WALLBETH,IBEOS,JONES,GSLP,BLUEOCEAN,USIBSILP,OVERNIGHT,JANEMID,IBATSEOS,HRTZERO,VIRTUALGO", "listingExchange": "NASDAQ", "countryCode": "US", "name": "APPLE INC", "lastTradingDay": null, "group": "Computers", "sector": "Technology", "sectorGroup": "Computers", "ticker": "AAPL", "type": "COMMON", "hasOptions": true, "fullName": "AAPL", "isUS": true, "incrementRules": \[ { "lowerEdge": 0.0, "increment": 0.01 } \], "displayRule": { "magnification": 0, "displayRuleStep": \[ { "decimalDigits": 2, "lowerEdge": 0.0, "wholeDigits": 4 } \] }, "isEventContract": false, "pageSize": 100 } \]\
\
\[\
  {\
    "acctId": "U1234567",\
...
EnlighterJS 3 Syntax Highlighter\
\
request\_url = f"{baseUrl}/portfolio/U1234567/positions/invalidate"\
\
json\_content = {}\
\
requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/positions/invalidate" json\_content = {} requests.post(url=request\_url, json=json\_content)\
\
request\_url = f"{baseUrl}/portfolio/U1234567/positions/invalidate"\
json\_content = {}\
requests.post(url=request\_url, json=json\_content)\
...
\--data '{}'\
\
curl \\ --url {{baseUrl}}/portfolio/U1234567/positions/invalidate \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{}'\
\
curl \\\
--url {{baseUrl}}/portfolio/U1234567/positions/invalidate \\\
--request POST \\\
...
request\_url = f"{baseUrl}/portfolio/U1234567/summary"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/portfolio/U1234567/summary" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/portfolio/U1234567/summary \\ --request GET
...
{ "accountcode": { "amount": 0.0, "currency": null, "isNull": false, "timestamp": 1702582422000, "value": "U1234567", "severity": 0 }, {...}, "indianstockhaircut": { "amount": 0.0, "currency": "USD", "isNone": false, "timestamp": 1702582422000, "value": null, "severity": 0 } }
...
request\_url = f"{baseUrl}/portfolio/U1234567/ledger"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/portfolio/U1234567/ledger" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/portfolio/U1234567/ledger \\ --request GET
...
request\_url = f"{baseUrl}/portfolio/positions/265598"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/portfolio/positions/265598" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/portfolio/positions/265598 \\ --request GET
...
\[ { "acctId": "U1234567", "conid": 265598, "contractDesc": "AAPL", "position": 614.2639, "mktPrice": 197.7639923, "mktValue": 121479.28, "currency": "USD", "avgCost": 192.7477563, "avgPrice": 192.7477563, "realizedPnl": 0.0, "unrealizedPnl": 3081.29, "exchs": null, "expiry": null, "putOrCall": null, "multiplier": null, "strike": 0.0, "exerciseStyle": null, "conExchMap": \[\], "assetClass": "STK", "undConid": 0, "model": "" } \]
...
request\_url = f"{baseUrl}/pa/performance"
...
request\_url = f"{baseUrl}/pa/performance" json\_content = { "acctIds": \["U1234567"\] } requests.post(url=request\_url, json=json\_content)
...
curl \\ {{baseUrl}}/pa/allperiods\\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "acctIds": \["U1234567", "U4567890"\]}'
...
{ "currencyType": "base", "rc": 0, "view": \[ "U1234567" \], "nd": 366, "id": "getPerformanceAllPeriods", "included": \[ "U1234567" \], "pm": "TWR", "U1234567": { "1D": { "nav": \[ 3666392.5393 \], "cps": \[ 0.0005 \], "freq": "D", "dates": \[ "20250603" \], "startNAV": { "date": "20250602", "val": 3664681.7504 } }, "lastSuccessfulUpdate": "2025-06-03 15:22:03", "start": "20240603", "YTD": { "nav": \[ 3674381.3273, ..., 3666392.5393 \], "cps": \[ 0, -0.0061, ..., -0.0021 \], "freq": "D", "dates": \[ "20250101", ..., "20250603" \], "startNAV": { "date": "20241231", "val": 3674236.8245 } }, "1Y": { "nav": \[ 3072764.5772, ..., 3666392.5393 \], "cps": \[ 0.0054, ..., 0.1996 \], "freq": "D", "dates": \[ "20240603", ..., "20250603" \], "startNAV": { "date": "20240531", "val": 3056403.4525 } }, "periods": \[ "1D", "7D", "MTD", "1M", "YTD", "1Y" \], "end": "20250603", "MTD": { "nav": \[ 3664681.7504, 3666392.5393 \], "cps": \[ 0.003, 0.0035 \], "freq": "D", "dates": \[ "20250602", "20250603" \], "startNAV": { "date": "20250530", "val": 3653634.7799 } }, "1M": { "nav": \[ 3626879.8271, ..., 3666392.5393 \], "cps": \[ -0.0046, ..., 0.0063 \], "freq": "D", "dates": \[ "20250505", ..., "20250603" \], "startNAV": { "date": "20250502", "val": 3643556.8781 } }, "7D": { "nav": \[ 3649592.4093, ..., 3666392.5393 \], "cps": \[ -0.0005, ..., 0.0041 \], "freq": "D", "dates": \[ "20250528", ..., "20250603" \], "startNAV": { "date": "20250527", "val": 3651501.5873 } }, "baseCurrency": "USD" } }
...
request\_url = f"{baseUrl}/pa/performance" json\_content = { "acctIds": \["U1234567"\] "period": "1D" } requests.post(url=request\_url, json=json\_content)
...
curl \\ {{baseUrl}}/pa/performance \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "acctIds": \["U1234567", "U4567890"\] "period": "1D" }'
...
{ "currencyType": "base", "rc": 0, "nav": { "data": \[ { "idType": "acctid", "navs": \[ 2.027673321223E8, {...}, 2.157185988239E8 \], "start": "20230102", "end": "20231213", "id": "U1234567", "startNAV": { "date": "20221230", "val": 2.027677613449E8 }, "baseCurrency": "USD" } \], "freq": "D", "dates": \[ "20230102", {...}, "20231213" \] }, "nd": 346, "cps": { "data": \[ { "idType": "acctid", "start": "20230102", "end": "20231213", "returns": \[ 0, {...}, 0.0639 \], "id": "U1234567", "baseCurrency": "USD" } \], "freq": "D", "dates": \[ "20230102", {...}, "20231213" \] }, "tpps": { "data": \[ { "idType": "acctid", "start": "20230102", "end": "20231213", "returns": \[ 0.0037, 0.0031, 0.0033, 0.0034, 0.02, 0.0127, 0.0036, 0.0036, 0.0034, 0.0012, 0.0026, 0.0017 \], "id": "U1234567", "baseCurrency": "USD" } \], "freq": "M", "dates": \[ "202301", "202302", "202303", "202304", "202305", "202306", "202307", "202308", "202309", "202310", "202311", "202312" \] }, "id": "getPerformanceData", "included": \[ "U1234567" \], "pm": "TWR" }
...
request\_url = f"{baseUrl}/pa/transactions"
...
request\_url = f"{baseUrl}/pa/transactions" json\_content = { "acctIds": \[ "U1234567" \], "conids": \[ 265598 \], "currency": "USD", "days": 3 } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/pa/transactions\\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "acctIds": \[ "U1234567" \], "conids": \[ 265598 \], "currency": "USD", "days": 3 }'
...
{ "rc": 0, "nd": 4, "rpnl": { "data": \[ { "date": "20231211", "cur": "USD", "fxRate": 1, "side": "L", "acctid": "U1234567", "amt": "12.2516", "conid": "265598" } \], "amt": "12.2516" }, "currency": "USD", "from": 1702270800000, "id": "getTransactions", "to": 1702530000000, "includesRealTime": true, "transactions": \[ { "date": "Mon Dec 11 00:00:00 EST 2023", "cur": "USD", "fxRate": 1, "pr": 192.26, "qty": -5, "acctid": "U1234567", "amt": 961.3, "conid": 265598, "type": "Sell", "desc": "Apple Inc" } \] }
...
request\_url = f"{baseUrl}/iserver/scanner/params"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/scanner/params" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/scanner/params \\ --request GET
...
{ "scan\_type\_list":\[ { "display\_name": "display\_name", "code": "code", "instruments": \[\] } \], "instrument\_list":\[ { "display\_name": "display\_name", "type": "type", "filters": \[\] } \], "filter\_list":\[ { "group": "group", "display\_name": "display\_name", "code": "code", "type": "type" } \], "location\_tree":\[ { "display\_name": "display\_name", "type": "type", "locations": \[ { "display\_name": "display\_name", "type": "type", "locations": \[\] } \] } \] }
...
request\_url = f"{baseUrl}/iserver/scanner/run"
...
request\_url = f"{baseUrl}/iserver/scanner/run" json\_content = { "instrument": "STK", "location": "STK.US.MAJOR", "type": "TOP\_TRADE\_COUNT", "filter": \[ { "code":"priceAbove", "value":5 } \] } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl/iserver/scanner/run \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "instrument": "STK", "location": "STK.US.MAJOR", "type": "TOP\_PERC\_GAIN", "filter": \[ { "code":"priceAbove", "value":5 } \] }'
...
"available\_chart\_periods": "#R|1",\
\
"company\_name": "ADVANCED MICRO DEVICES",\
\
"scan\_data": "163.773K",\
\
"contract\_description\_1": "AMD",\
\
"listing\_exchange": "NASDAQ.NMS",\
\
"sec\_type": "STK"\
...
"scan\_data\_column\_name": "Trades"

}

{ "contracts": \[ { "server\_id": "0", "symbol": "AMD", "conidex": "4391", "con\_id": 4391, "available\_chart\_periods": "#R|1", "company\_name": "ADVANCED MICRO DEVICES", "scan\_data": "163.773K", "contract\_description\_1": "AMD", "listing\_exchange": "NASDAQ.NMS", "sec\_type": "STK" } \], "scan\_data\_column\_name": "Trades" }
...
Developers should first call the [/hmds/auth/init](./cpapi-v1.md#hmds-init)
 endpoint prior to their request to avoid an initial 404 rejection.
...
request\_url = f"{baseUrl}/hmds/scanner"
...
"scanCode": "HIGH\_BOND\_ASK\_YIELD\_ALL",
...
request\_url = f"{baseUrl}/hmds/scanner" json\_content= { "instrument":"BOND", "locations": "BOND.US", "scanCode": "HIGH\_BOND\_ASK\_YIELD\_ALL", "secType": "BOND", "delayedLocations":"SMART", "maxItems":25, "filters":\[{ "bondAskYieldBelow": 15.819 }\] } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/hmds/scanner \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "instrument":"BOND", "locations": "BOND.US", "scanCode": "HIGH\_BOND\_ASK\_YIELD\_ALL", "secType": "BOND", "delayedLocations":"SMART", "maxItems":25, "filters":\[{ "bondAskYieldBelow": 15.819 }\] }'
...
{ "total": "17262", "size": "250", "offset": "0", "scanTime": "20231214-18:55:25", "id": "scanner1", "position": "v1:AAAAAQABG3gAAAAAAAAA+g==", "Contracts": { "Contract": \[ { "inScanTime": "20231214-18:55:25", "contractID": "431424315" }, \] }
...
request\_url = f"{baseUrl}/iserver/auth/status"

json\_content = {}

requests.post(url=request\_url, json=json\_content)

request\_url = f"{baseUrl}/iserver/auth/status" json\_content = {} requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/auth/status \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{}'
...
"hardware\_info": "3b0679ee|98:A2:B3:23:BC:A0",

"fail": ""

}

{ "authenticated": true, "competing": false, "connected": true, "message": "", "MAC": "12:B:B3:23:BF:A0", "serverInfo": { "serverName": "JifN19053", "serverVersion": "Build 10.25.0p, Dec 5, 2023 5:48:12 PM" }, "hardware\_info": "3b0679ee|98:A2:B3:23:BC:A0", "fail": "" }
...
{ "authenticated": false, "competing": false, "connected": false, "MAC": "98:B2:C3:45:DE:F6" }
...
request\_url = "{baseUrl}/iserver/auth/ssodh/init"

json\_content= {"publish":True,"compete":True}

requests.post(url=request\_url, json=json\_content)

request\_url = "{baseUrl}/iserver/auth/ssodh/init" json\_content= {"publish":True,"compete":True} requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/auth/ssodh/init \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "publish":true, "compete":true }'
...
{ "authenticated": true, "competing": false, "connected": true, "message": "", "MAC": "98:F2:B3:23:BF:A0", "serverInfo": { "serverName": "JifN19053", "serverVersion": "Build 10.25.0p, Dec 5, 2023 5:48:12 PM" } }
...
request\_url = "{baseUrl}/logout"

json\_content= {}

requests.post(url=request\_url, json=json\_content)

request\_url = "{baseUrl}/logout" json\_content= {} requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/logout \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{}'
...
request\_url = f"{baseUrl}/tickle"

json\_content = {}

requests.post(url=request\_url, json=json\_content)

request\_url = f"{baseUrl}/tickle" json\_content = {} requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/tickle \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{}'
...
**iserver:** object.  
Returns the content of the [/iserver/auth/status](./cpapi-v1.md#auth-status)
 endpoint.
...
{ "session": "bb665d0f55b6289d70bc7380089fc96f", "ssoExpires": 460311, "collission": false, "userId": 123456789, "hmds": { "error": "no bridge" }, "iserver": { "authStatus": { "authenticated": true, "competing": false, "connected": true, "message": "", "MAC": "98:F2:B3:23:BF:A0", "serverInfo": { "serverName": "JifN19053", "serverVersion": "Build 10.25.0p, Dec 5, 2023 5:48:12 PM" } } } }
...
All interest in reauthenticating the gateway session should be handled using the [/iserver/auth/ssodh/init](https://www.interactivebrokers.com/campus/ibkr-api-page/cpapi/#ssodh-init)
 endpoint.
...
request\_url = f"{baseUrl}/iserver/reauthenticate"

json\_content = {}

requests.post(url=request\_url, json=json\_content )

request\_url = f"{baseUrl}/iserver/reauthenticate" json\_content = {} requests.post(url=request\_url, json=json\_content )
...
curl \\ --url {{baseUrl}}/iserver/reauthenticate \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{}'
...
request\_url = f"{baseUrl}/sso/validate"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/sso/validate" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/sso/validate \\ --request GET
...
"AUTH\_TIME": 1702580846836,

"SF\_ENABLED": false,

"IS\_FREE\_TRIAL": false,
...
"QUALIFIED\_FOR\_MOBILE\_AUTH": null,

"LANDING\_APP": "UNIVERSAL",
...
{ "USER\_ID": 123456789, "USER\_NAME": "user1234", "RESULT": true, "AUTH\_TIME": 1702580846836, "SF\_ENABLED": false, "IS\_FREE\_TRIAL": false, "CREDENTIAL": "user1234", "IP": "12.345.678.901", "EXPIRES": 415890, "QUALIFIED\_FOR\_MOBILE\_AUTH": null, "LANDING\_APP": "UNIVERSAL", "IS\_MASTER": false, "lastAccessed": 1702581069652, "LOGIN\_TYPE": 2, "PAPER\_USER\_NAME": "user1234", "features": { "env": "PROD", "wlms": true, "realtime": true, "bond": true, "optionChains": true, "calendar": true, "newMf": true }, "region": "NJ" }
...
request\_url = f"{baseUrl}/iserver/watchlist"
...
request\_url = f"{baseUrl}/iserver/watchlist" json\_content = { "id":"1234", "name":"Test Watchlist", "rows":\[ {"C":8314}, {"C":8894} \] } requests.post(url=request\_url, json=json\_content)
...
curl \\ --url {{baseUrl}}/iserver/watchlist \\ --request POST \\ --header 'Content-Type:application/json' \\ --data '{ "id":"1234", "name":"Test Watchlist", "rows":\[ {"C":8314}, {"C":8894} \] }'
...
See the [/iserver/watchlist?id](./cpapi-v1.md#watchlist-info)
...
{ "id": "1234", "hash": "1702581306241", "name": "Test Watchlist", "readOnly": false, "instruments": \[\] }
...
request\_url = f"{baseUrl}/iserver/watchlist?SC=USER\_WATCHLIST"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/watchlist?SC=USER\_WATCHLIST" requests.get(url=request\_url)
...
\--url {{baseUrl}}/iserver/watchlists?SC\=USER\_WATCHLIST \\

\--request GET

curl \\ --url {{baseUrl}}/iserver/watchlists?SC=USER\_WATCHLIST \\ --request GET
...
"scanners\_only": false,

"show\_scanners": false,
...
{ "data": { "scanners\_only": false, "show\_scanners": false, "bulk\_delete": false, "user\_lists": \[ { "is\_open": false, "read\_only": false, "name": "Test Watchlist", "modified": 1702581306241, "id": "1234", "type": "watchlist" } \] }, "action": "content", "MID": "1" }
...
request\_url = f"{baseUrl}/iserver/watchlist?id=1234"

requests.get(url=request\_url)

request\_url = f"{baseUrl}/iserver/watchlist?id=1234" requests.get(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/watchlist?id=1234 \\ --request GET
...
{ "id": "1234", "hash": "1702581306241", "name": "Test Watchlist", "readOnly": false, "instruments": \[ { "ST": "STK", "C": "8314", "conid": 8314, "name": "INTL BUSINESS MACHINES CORP", "fullName": "IBM", "assetClass": "STK", "ticker": "IBM", "chineseName": "国际商业机器" }, { "ST": "STK", "C": "8894", "conid": 8894, "name": "COCA-COLA CO/THE", "fullName": "KO", "assetClass": "STK", "ticker": "KO", "chineseName": "可口可乐" } \] }
...
request\_url = f"{baseUrl}/iserver/watchlist?id=1234" requests.delete(url=request\_url)
...
curl \\ --url {{baseUrl}}/iserver/watchlist?id=1234 \\ --request DELETE
...
{ "data": { "deleted": "1234" }, "action": "context", "MID": "2" }
...
Websocket topics expose the same underlying data as is delivered by the HTTP endpoints. Functionality that requires a brokerage session (that is, all features behind /iserver URIs) will also require a brokerage session when accessed via websocket. Please ensure you have an active brokerage session before attempting to use these features of the websocket. For information on getting started with Client Portal API, please refer to the [Authentication](./cpapi-v1.md#authentication)
 section.
...
If you require brokerage functionality, you will need to establish a brokerage session prior to opening a websocket, just as is required before making requests to /iserver endpoints. Please see [Authentication](./cpapi-v1.md#authentication)
 for more details.

### Request Session Information


First make request the [/tickle](./cpapi-v1.md#tickle)
 endpoint and save the returned session value.
...
{ "session": "d21b8cf5ebc8ea01c6ce37c8125ec83f", "ssoExpires": ssoExpires, "collission": collission, "userId": userId, "hmds": { "error": "no bridge" }, "iserver": { "authStatus": { "authenticated": true, "competing": false, "connected": true, "message": "", "MAC": "MAC", "serverInfo": { "serverName": "serverName", "serverVersion": "serverVersion" } } } }
...
ws = websocket.WebSocketApp( url="wss://localhost:5000/v1/api/ws", on\_open=on\_open, on\_message=on\_message, on\_error=on\_error, on\_close=on\_close, cookie=f"api={sessionToken}" ) ws.run\_forever()
...
url="wss://api.ibkr.com/v1/api/ws?oauth\_token={accessToken}",
...
ws = websocket.WebSocketApp( url="wss://api.ibkr.com/v1/api/ws?oauth\_token={accessToken}", on\_open=on\_open, on\_message=on\_message, on\_error=on\_error, on\_close=on\_close, cookie=f"api={sessionToken}" ) ws.run\_forever()
...
curl -i -N -H "Connection: Upgrade" -H "Upgrade: websocket" -H "origin: interactivebrokers.github.io" --cookie "api=d21b8cf5ebc8ea01c6ce37c8125ec83f" wss://api.ibkr.com/v1/api/ws?oauth\_token={Access Token}
...
on\_open(ws): print("Opened Connection") time.sleep(3) ws.send('smd+265598+{"fields":\["31","84","86"\]}')
...
{"result":\[ { "key":"key1", "currency":"currency", "monetaryValue":monetaryValue, "severity":0, "timestamp":timestamp }, { "key":"key2", "currency":"currency", "value":value, "severity":0, "timestamp":timestamp }, \]}
...
sld+DU1234567+{ "keys":\["LedgerListBASE","LedgerListEUR"\], "fields":\["cashBalance","exchangeRate"\] }
...
{ "result": \[ { "acctCode": "DU1234567", "cashbalance": 2.0201311791131118E8, "cashBalanceFXSegment": 0.0, "commodityMarketValue": 0.0, "corporateBondsMarketValue": 0.0, "key": "LedgerListBASE", "dividends": 0.0, "exchangeRate": 1.0, "funds": 0.0, "marketValue": 0.0, "optionMarketValue": 0.0, "interest": 396687.69214935537, "issueOptionsMarketValue": 0.0, "moneyFunds": 0.0, "netLiquidationValue": 2.0280151634374067E8, "realizedPnl": 0.0, "unrealizedPnl": 249013.5397937378, "secondKey": "BASE", "settledCash": 2.0201311791131118E8, "severity": 0, "stockMarketValue": 391710.74028015137, "tBillsMarketValue": 0.0, "tBondsMarketValue": 0.0, "warrantsMarketValue": 0.0, "timestamp": 1700248325 }, { "key": "LedgerListCAD", "timestamp": 1700248325 }, { "key": "LedgerListUSD", "timestamp": 1700248325 }, { "key": "LedgerListEUR", "timestamp": 1700248325 }, { "key": "LedgerListCHF", "timestamp": 1700248325 } \], "topic": "sld+DU1234567" }
...
**NOTE:** The maximum number of market data subscriptions is based on your account’s [Market Data Lines](../general/market-data-subscriptions.md#market-data-lines)
.
...
Combos or Spreads market data can be retrieved using identical formatting to [Combo or Spread Orders](./cpapi-v1.md#combo-orders)
. The only difference is that a spread\_conid of 0 must be passed.
...
smd+conId+{ \[ "fields":"field\_1", "field\_2", "field\_n", "field\_n+1" \] }
...
**fields\*:** String.  
Returns a response for each request. Some fields not be as readily available as others. See the [Market Data](./cpapi-v1.md#market-data)
 section for more details.
...
{ "server\_id":"server\_id", "conidEx":"conidEx", "conid":conid," \_updated":\_updated, "6119":"serverId", "field\_1":field\_1, "field\_2":field\_2, "field\_n":field\_n, "field\_n+1":field\_n+1, "6509":"RB", "topic":"smd+conid" }
...
{ "serverId": "serverId", "symbol": "symbol", "text": "text", "priceFactor": priceFactor, "startTime": "startTime", "high": "high", "low": "low", "timePeriod": "timePeriod", "barLength": barLength, "mdAvailability": "mdAvailability", "mktDataDelay": mktDataDelay, "outsideRth": outsideRth, "volumeFactor": volumeFactor, "priceDisplayRule": priceDisplayRule, "priceDisplayValue": "priceDisplayValue", "negativeCapable": negativeCapable, "messageVersion": messageVersion, "data": \[data\], "points": points, "topic": "topic", }
...
| period: String | Request duration | *   {1-30}min<br>*   {1-8}h<br>*   {1-1000}d<br>*   {1-792}w<br>*   {1-182}m<br>*   {1-15}y |
| bar: String | Request bar size | *   1min<br>*   2min<br>*   3min<br>*   5min<br>*   10min<br>*   15min<br>*   30min<br>*   1h<br>*   2h<br>*   3h<br>*   4h<br>*   8h<br>*   1d<br>*   1w<br>*   1m |
| outsideRTH: Boolean | Request data outside trading hours | true/false |
| source: String | Type of date requested | *   midpoint<br>*   trades<br>*   bid\_ask<br>*   bid<br>*   ask |
| format: String | Historical values returned | *   %o – open<br>*   %c – close<br>*   %h – high<br>*   %l – low<br>*   %v – volume |
...
Streaming BookTrader data requires users to maintain a L2, Depth of Book, market data subscription. See the [Market Data Subscriptions page](../general/market-data-subscriptions.md#popular-md-subscriptions)
 for more details.
...
{ "topic":"sbd+acctId+conid", "data":\[ {"row":0,"focus":0,"price":"price"}, {"row":1,"focus":0,"price":"size @ price"}, {"row":n,"focus":0,"price":"price", "bid":"bid"}, {"row":n+1,"focus":0,"price":"price", "ask":"ask"}, {"row":n+1,"focus":0,"price":"size @ price", "ask":"ask"} \] }
...
Developers should also maintain [Live Order Updates](./cpapi-v1.md#ws-order-updates-sub)
 while exercising options to confirm final results.
...
shs+exercise+{"CEX":"Your\_Option\_Conid"}
...
{"data":{"user\_action":\[{"id":"submit","text":"Submit"},{"id":"cancel","text":"Cancel"}\],"underlying\_price":"$211.35","contract":"\*\*AAPL\*\* JUN 28 '24 192.5 Call","underlying\_symbol":"AAPL","exercise":{"confirm":false,"confirm\_final":false,"enabled":true},"revocable":false,"loading":true,"hold":{"confirm":false,"enabled":true},"qty\_lapse":0,"submitted":0,"qty\_hold":0,"sec\_type":"OPT","qty\_exercise":0,"underlying\_conid":"265598","morning\_expiration":false,"id":5,"position":50,"deadline":"16:25"},"action":"content","MID":"14","topic":"shs+exercise"}

{"data":{"submitted":0,"qty\_hold":0,"qty\_exercise":0,"warning":"Currently the option is in-the-money by the amount of 18.85 (more than 5 ticks)","exercise":{"confirm":false,"enabled":true},"revocable":false,"loading":false,"qty\_lapse":0},"action":"content","MID":"17","topic":"shs+exercise"}

{"topic":"shs+exercise"} {"data":{"user\_action":\[{"id":"submit","text":"Submit"},{"id":"cancel","text":"Cancel"}\],"underlying\_price":"$211.35","contract":"\*\*AAPL\*\* JUN 28 '24 192.5 Call","underlying\_symbol":"AAPL","exercise":{"confirm":false,"confirm\_final":false,"enabled":true},"revocable":false,"loading":true,"hold":{"confirm":false,"enabled":true},"qty\_lapse":0,"submitted":0,"qty\_hold":0,"sec\_type":"OPT","qty\_exercise":0,"underlying\_conid":"265598","morning\_expiration":false,"id":5,"position":50,"deadline":"16:25"},"action":"content","MID":"14","topic":"shs+exercise"} {"data":{"submitted":0,"qty\_hold":0,"qty\_exercise":0,"warning":"Currently the option is in-the-money by the amount of 18.85 (more than 5 ticks)","exercise":{"confirm":false,"enabled":true},"revocable":false,"loading":false,"qty\_lapse":0},"action":"content","MID":"17","topic":"shs+exercise"}
...
inp+exercise+{"action":"user\_input","data":{"id":"5","user\_action":"submit","exercise":{"allowed":"not\_shown","make\_final":true,"value":5}}}
...
{"data":{"user\_actions":\[{"id":"continue","text":"Continue"},{"id":"cancel","text":"Cancel"}\],"id":7,"text":"This exercise request will be final and irreversible. Once submitted, the option position and the stock position will update immediately.","title":"Warning"},"MID":"19","action":"prompt","topic":"inp+exercise"}
...
inp+exercise+{"action":"user\_input","data":{"id":"7","user\_action":"continue"}
...
{"topic":"sor","args":\[{"acct":"DU1234567","conidex":"708764406","conid":708764406,"account":"DU1234567","orderId":827785484,"cashCcy":"USD","sizeAndFills":"0/5","orderDesc":"EXERCISE 5, Day","description1":"AAPL","description2":"JUN 28 '24 192.5 Call","ticker":"AAPL","secType":"OPT","remainingQuantity":5.0,"filledQuantity":0.0,"totalSize":5.0,"companyName":"APPLE INC","status":"Inactive","order\_ccp\_status":"Pending Submit","supportsTaxOpt":"1","lastExecutionTime":"240624150344","bgColor":"#000000","fgColor":"#AFAFAF","isEventTrading":"0","lastExecutionTime\_r":1719241424000,"side":"EXER"}\]}
...
Pass an array with a single string indicating exclusive [Order Status Value](./cpapi-v1.md#order-status-value)
 to return.
...
{ "topic": "sor" , "args": \[ { "acct": "acct", "conid": conid, "orderId": orderId, "cashCcy": "cashCcy", "sizeAndFills": "sizeAndFills", "orderDesc": "orderDesc", "description1": "description1", "ticker": "ticker", "secType": "secType", "listingExchange": "listingExchange", "remainingQuantity": remainingQuantity, "filledQuantity": filledQuantity, "companyName": "companyName", "status": "status", "origOrderType": "origOrderType", "supportsTaxOpt": "supportsTaxOpt", "lastExecutionTime": "lastExecutionTime", "lastExecutionTime\_r": lastExecutionTime\_r, "order\_ref": "order\_ref, "orderType": "orderType", "side": "side", "timeInForce": "timeInForce", "price": price, "bgColor": "#000000", "fgColor": "#00F000" } \] }
...
"symbol":"symbol"\
\
"supports\_tax\_opt":"supports\_tax\_opt"\
\
"side":"side"\
\
"order\_description":"order\_description"\
\
"trade\_time":"trade\_time"\
\
"trade\_time\_r":trade\_time\_r\
\
"size":size\
\
"order\_ref": "order\_ref"\
...
\
"contract\_description\_1":"contract\_description\_1"\
\
"contract\_description\_2":"contract\_description\_2"\
\
"sec\_type":"sec\_type"\
\
"conid":conid\
...
"conidEx":"conidEx"\
\
"open\_close":"open\_close"\
\
"liquidation\_trade":"liquidation\_trade"\
\
"is\_event\_trading":"is\_event\_trading"\
\
}\
\
\]
...
{ "topic":"topic" "args":\[ { "execution\_id":"execution\_id" "symbol":"symbol" "supports\_tax\_opt":"supports\_tax\_opt" "side":"side" "order\_description":"order\_description" "trade\_time":"trade\_time" "trade\_time\_r":trade\_time\_r "size":size "order\_ref": "order\_ref" "price":"price" "exchange":"exchange" "net\_amount":net\_amount "account":"account" "accountCode":"accountCode" "company\_name":"company\_name" "contract\_description\_1":"contract\_description\_1" "contract\_description\_2":"contract\_description\_2" "sec\_type":"sec\_type" "conid":conid "conidEx":"conidEx" "open\_close":"open\_close" "liquidation\_trade":"liquidation\_trade" "is\_event\_trading":"is\_event\_trading" } \] }
...
{ "topic":"act", "args":{ "accounts":\[\], "acctProps":{ "All":{ "hasChildAccounts":hasChildAccounts, "supportsCashQty":supportsCashQty, "noFXConv":noFXConv, "isProp":isProp, "supportsFractions":supportsFractions, "allowCustomerTime":allowCustomerTime } }, "aliases":{}, "allowFeatures":{ "showGFIS":showGFIS, "showEUCostReport":showEUCostReport, "allowEventContract":allowEventContract, "allowFXConv":allowFXConv, "allowFinancialLens":allowFinancialLens, "allowMTA":allowMTA, "allowTypeAhead":allowTypeAhead, "allowEventTrading":allowEventTrading, "snapshotRefreshTimeout":snapshotRefreshTimeout, "liteUser":liteUser, "showWebNews":showWebNews, "research":research, "debugPnl":debugPnl, "showTaxOpt":showTaxOpt, "showImpactDashboard":showImpactDashboard, "allowDynAccount":allowDynAccount, "allowCrypto":allowCrypto, "allowedAssetTypes":"allowedAssetTypes" }, "chartPeriods":{ "STK":\[\], "CFD":\[\], "OPT":\[\], "FOP":\[\], "WAR":\[\], "IOPT":\[\], "FUT":\[\], "CASH":\[\], "IND":\[\], "BOND":\[\], "FUND":\[\], "CMDTY":\[\], "PHYSS":\[\], "CRYPTO":\[\] }, "groups":\[\], "profiles":\[\], "selectedAccount":"selectedAccount", "serverInfo":{ "serverName":"serverName", "serverVersion":"serverVersion" }, "sessionId":"sessionId", "isFT":isFT, "isPaper":isPaper } }
...
{ "topic": "ntf", "args": { "id": "id", "text": "text", "title": "title", "url": "url" } }
...
Interactive Brokers offers an OAuth 1.0a authentication procedure for licensed Financial Advisors, Organizations, IBrokers, and third party services. Beyond the initial authentication procedure, the OAuth implementation will behave the same as the standard [Client Portal Gateway](./cpapi-v1.md#cpgw)
.
...
Once you are registered in the Self-Service portal, all authentication will begin with the /live\_session\_token endpoint. Then you may begin making [Authenticated Requests With OAuth 1.0A](./cpapi-v1.md#standard-oauth)
 for our [Standard Endpoints](./cpapi-v1.md#endpoints)
.

[Live Session Token Endpoint](./cpapi-v1.md#lst)
...
Once approved for Third Party OAuth, developers must use the supplied certificates and consumer key to register, authorize, and generate an access token for a user before they are able to retrieve a live session token for [Authenticated Requests With OAuth 1.0A](./cpapi-v1.md#standard-oauth)
.

[1\. Generate a Request Token](./cpapi-v1.md#request-token)
 [2\. Authorize The Consumer Key](./cpapi-v1.md#oauth-authorize)
 [3, Generate Access Tokens](./cpapi-v1.md#access-token)
 [4\. Generate a Live Session Token](./cpapi-v1.md#lst)
...
To get a request token, an OAuth request to

https://api.ibkr.com/v1/api/oauth/request\_token

`https://api.ibkr.com/v1/api/oauth/request_token` must be made.

The request should be a POST request but with no body. Remember that [an authorization header](./cpapi-v1.md#auth-header)
 has to be authorize the connection.
...
**Important:** If you are a First Party OAuth users, do not follow this step. You will receive an error. For developers implementing First Party OAuth, proceed directly to [Requesting the Live Session Token](./cpapi-v1.md#lst)
.
...
"oauth\_consumer\_key": "TESTCONS",

"oauth\_signature\_method": "RSA-SHA256",

"oauth\_signature": "fnHGXncCkcnB3U3jYxjh%2BgUdo7PelK5NQGIedbDeAQgDtO02ccLVapH5QtpazS%2BKlwg7bJTAgxsM1T5QOox6IjBQJu91EJ%2FFVUCFtd8rNbRQNGbEWdibglWErBDuHY%2FVCLRHdCqAg9BhV%2BZ7FTY6oCT9HSQr6ZK%2FgNqTd58vpt5z8cPCoPHRJN4HzB54J5A4K7R7aEx9s1B5wqIer7fdVIzKb0KSSpP44Hx%2BGnLfZINfQHIrRCfFwbeGEvi31PF9ICWRIKZz5LxqX6OtT0Dze8LiZo7PnkrA5b0m9PR0cP1v6DSBVaSyJXBITiml9Gyn2HuiexHjRJt85gPhNiU3VA%3D%3D",

"oauth\_timestamp": "1722886851",

"oauth\_nonce": "a568f4e3b0e161b0dcf187331b8274be",

"oauth\_callback": "oob"

}

{ "oauth\_consumer\_key": "TESTCONS", "oauth\_signature\_method": "RSA-SHA256", "oauth\_signature": "fnHGXncCkcnB3U3jYxjh%2BgUdo7PelK5NQGIedbDeAQgDtO02ccLVapH5QtpazS%2BKlwg7bJTAgxsM1T5QOox6IjBQJu91EJ%2FFVUCFtd8rNbRQNGbEWdibglWErBDuHY%2FVCLRHdCqAg9BhV%2BZ7FTY6oCT9HSQr6ZK%2FgNqTd58vpt5z8cPCoPHRJN4HzB54J5A4K7R7aEx9s1B5wqIer7fdVIzKb0KSSpP44Hx%2BGnLfZINfQHIrRCfFwbeGEvi31PF9ICWRIKZz5LxqX6OtT0Dze8LiZo7PnkrA5b0m9PR0cP1v6DSBVaSyJXBITiml9Gyn2HuiexHjRJt85gPhNiU3VA%3D%3D", "oauth\_timestamp": "1722886851", "oauth\_nonce": "a568f4e3b0e161b0dcf187331b8274be", "oauth\_callback": "oob" }
...
url = f'https://api.ibkr.com/v1/api/oauth/request\_token'

oauth\_params = {

"oauth\_callback": {{oauth\_callback }},

"oauth\_consumer\_key": {{consumer\_key}},

"oauth\_nonce": hex(random.getrandbits(128))\[2:\],

"oauth\_signature\_method": "RSA-SHA256",

"oauth\_timestamp": str(int(datetime.now().timestamp())),

}

params\_string = "&".join(\[f"{k}={v}" for k, v in sorted(oauth\_params.items())\])

\# Base string successfully created

base\_string = f"POST&{quote\_plus(url)}&{quote(params\_string)}"

\# Base string should then signed with the private key in RSA-SHA256

encoded\_base\_string = base\_string.encode("utf-8")

sha256\_hash = SHA256.new(data=encoded\_base\_string)

bytes\_pkcs115\_signature = PKCS1\_v1\_5\_Signature.new(

rsa\_key=signature\_key

).sign(msg\_hash=sha256\_hash)

b64\_str\_pkcs115\_signature = base64.b64encode(bytes\_pkcs115\_signature).decode("utf-8")

\# Establish the authorization header

oauth\_params\["oauth\_signature"\] = quote\_plus(b64\_str\_pkcs115\_signature)

oauth\_params\["realm"\] = realm

oauth\_header = "OAuth " + ", ".join(\[f'{k}="{v}"' for k, v in sorted(oauth\_params.items())\])

headers = {"authorization": oauth\_header}

headers\["User-Agent"\] = "python/3.11"

request\_request = requests.post(url=url, headers=headers)

if request\_request.status\_code == 200:

rToken = request\_request.json()\["oauth\_token"\]

url = f'https://api.ibkr.com/v1/api/oauth/request\_token' oauth\_params = { "oauth\_callback": {{oauth\_callback }}, "oauth\_consumer\_key": {{consumer\_key}}, "oauth\_nonce": hex(random.getrandbits(128))\[2:\], "oauth\_signature\_method": "RSA-SHA256", "oauth\_timestamp": str(int(datetime.now().timestamp())), } params\_string = "&".join(\[f"{k}={v}" for k, v in sorted(oauth\_params.items())\]) # Base string successfully created base\_string = f"POST&{quote\_plus(url)}&{quote(params\_string)}" # Base string should then signed with the private key in RSA-SHA256 encoded\_base\_string = base\_string.encode("utf-8") sha256\_hash = SHA256.new(data=encoded\_base\_string) bytes\_pkcs115\_signature = PKCS1\_v1\_5\_Signature.new( rsa\_key=signature\_key ).sign(msg\_hash=sha256\_hash) b64\_str\_pkcs115\_signature = base64.b64encode(bytes\_pkcs115\_signature).decode("utf-8") # Establish the authorization header oauth\_params\["oauth\_signature"\] = quote\_plus(b64\_str\_pkcs115\_signature) oauth\_params\["realm"\] = realm oauth\_header = "OAuth " + ", ".join(\[f'{k}="{v}"' for k, v in sorted(oauth\_params.items())\]) headers = {"authorization": oauth\_header} headers\["User-Agent"\] = "python/3.11" request\_request = requests.post(url=url, headers=headers) if request\_request.status\_code == 200: rToken = request\_request.json()\["oauth\_token"\]
...
"oauth\_token": "b9082d68cfef06b030de"
...
An example of url after the user logs in

https://localhost:20000/?oauth\_token=b9082d68cfef06b030de&oauth\_verifier=0ffb93ab9aa0d2177cc2

`https://localhost:20000/?oauth_token=b9082d68cfef06b030de&oauth_verifier=0ffb93ab9aa0d2177cc2`
...
https://interactivebrokers.com/authorize?oauth\_token={{ Request Token }}
...
url = f'https://interactivebrokers.com/authorize?oauth\_token={rToken}'

vToken = input(f"Please log in to {url} and paste the 'oauth\_verifier' value here: ")

url = f'https://interactivebrokers.com/authorize?oauth\_token={rToken}' vToken = input(f"Please log in to {url} and paste the 'oauth\_verifier' value here: ")
...
![Callback URL displayed in browser](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/11/authorize_response.png)
...
oauth\_token must also be added to the authorization header, the value being [the request token](./cpapi-v1.md#request-token)
.
...
"oauth\_token": "47b63b7961c51e1df1e6",

"oauth\_signature\_method": "RSA-SHA256",

"oauth\_signature": "V9p9e41Zx8Fsi1QkJq3QewZdt%2BZM8GTCcKswY08MbZKCHsob57JEdNbpeANWkiwqVdDnRArQ52ifQsutYlvXvsUQAVd2vuiMqcEqpGN8c2ZmTqVQbQwNaqw0LLXQ84DmwDUWJa%2F8pSJPmCmMPi4tJPKb%2Bta1DyVN2ec8KwzRw8c7MpKsbKBXXC%2B0vJ7Y8kTE0WnoiPA%2FJ8sRn7sZnlsDlEmyxNY%2Fggrr%2F5GJTQFe2EXka5eMsHrnWTYdC1tg38%2BVebt4HNyptLUCO0%2FpeZVRbjN3RyfPlDpSlJ6jGh2lqtcyLEueDsxvN%2FsRWjpiBl1in%2Bou6YYeB2D%2FBz%2Bttvpagw%3D%3D",

"oauth\_timestamp": "1722030398",

"oauth\_nonce": "734860ccbc2f14ae971a8cf1a6ec936",

"oauth\_verifier": "01028463e73960e27b3f"

}

{ "oauth\_consumer\_key": "TESTCONS", "oauth\_token": "47b63b7961c51e1df1e6", "oauth\_signature\_method": "RSA-SHA256", "oauth\_signature": "V9p9e41Zx8Fsi1QkJq3QewZdt%2BZM8GTCcKswY08MbZKCHsob57JEdNbpeANWkiwqVdDnRArQ52ifQsutYlvXvsUQAVd2vuiMqcEqpGN8c2ZmTqVQbQwNaqw0LLXQ84DmwDUWJa%2F8pSJPmCmMPi4tJPKb%2Bta1DyVN2ec8KwzRw8c7MpKsbKBXXC%2B0vJ7Y8kTE0WnoiPA%2FJ8sRn7sZnlsDlEmyxNY%2Fggrr%2F5GJTQFe2EXka5eMsHrnWTYdC1tg38%2BVebt4HNyptLUCO0%2FpeZVRbjN3RyfPlDpSlJ6jGh2lqtcyLEueDsxvN%2FsRWjpiBl1in%2Bou6YYeB2D%2FBz%2Bttvpagw%3D%3D", "oauth\_timestamp": "1722030398", "oauth\_nonce": "734860ccbc2f14ae971a8cf1a6ec936", "oauth\_verifier": "01028463e73960e27b3f" }
...
url = f'https://api.ibkr.com/v1/api/oauth/access\_token'

oauth\_params = {

"oauth\_callback":callback,
...
atoken\_request = requests.post(url=url, headers=headers)

aToken = atoken\_request.json()\["oauth\_token"\]

aToken\_secret = atoken\_request.json()\["oauth\_token\_secret"\]

url = f'https://api.ibkr.com/v1/api/oauth/access\_token' oauth\_params = { "oauth\_callback":callback, "oauth\_consumer\_key": consumer\_key, "oauth\_nonce": hex(random.getrandbits(128))\[2:\], "oauth\_signature\_method": "RSA-SHA256", "oauth\_timestamp": str(int(datetime.now().timestamp())), "oauth\_token": rToken, "oauth\_verifier": vToken, } params\_string = "&".join(\[f"{k}={v}" for k, v in sorted(oauth\_params.items())\]) # Base string successfully created base\_string = f"POST&{quote\_plus(url)}&{quote(params\_string)}" # Base string should then signed with the private key in RSA-SHA256 encoded\_base\_string = base\_string.encode("utf-8") sha256\_hash = SHA256.new(data=encoded\_base\_string) bytes\_pkcs115\_signature = PKCS1\_v1\_5\_Signature.new( rsa\_key=signature\_key ).sign(msg\_hash=sha256\_hash) b64\_str\_pkcs115\_signature = base64.b64encode(bytes\_pkcs115\_signature).decode("utf-8") # Establish the authorization header oauth\_params\["oauth\_signature"\] = quote\_plus(b64\_str\_pkcs115\_signature) oauth\_params\["realm"\] = realm oauth\_header = "OAuth " + ", ".join(\[f'{k}="{v}"' for k, v in sorted(oauth\_params.items())\]) headers = {"authorization": oauth\_header} headers\["User-Agent"\] = "python/3.11" # Send the request and save the tokens to variables atoken\_request = requests.post(url=url, headers=headers) aToken = atoken\_request.json()\["oauth\_token"\] aToken\_secret = atoken\_request.json()\["oauth\_token\_secret"\]
...
If you are an IB customer who registered using the Self-Service OAuth page then on that same page you should have completed [the Access Token step](./cpapi-v1.md#access-token)
. You would now proceed to this final step to complete the OAuth authorization process.

### Endpoint


The live session token will allow the user to access their API, for trading or for portfolio access, over a 24 hour period. The creation of the Live Session Token does not establish a complete trading session, as that would be handled by [Initializing the Brokerage Session](./cpapi-v1.md#ssodh-init)
.

POST /oauth/live\_session\_token
...
dh\_random = str(random.getrandbits(256))
...
BigInteger dh\_random = random.Next(1, int.MaxValue);

Random random = new(); BigInteger dh\_random = random.Next(1, int.MaxValue);
...
dh\_param = RSA.importKey(f.read())

dh\_prime = dh\_param.n \# Also known as DH Modulus

dh\_generator = dh\_param.e \# always =2

\# Convert result to hex and remove leading 0x chars.

dh\_challenge = hex(pow(base=dh\_generator, exp=dh\_random, mod=dh\_prime))\[2:\]

\# Replace with path to DH param PEM file. with open("./dhparam.pem, "r") as f: dh\_param = RSA.importKey(f.read()) dh\_prime = dh\_param.n # Also known as DH Modulus dh\_generator = dh\_param.e # always =2 # Convert result to hex and remove leading 0x chars. dh\_challenge = hex(pow(base=dh\_generator, exp=dh\_random, mod=dh\_prime))\[2:\]
...
// Extract our dh\_modulus and dh\_generator values from our dhparam.pem file's bytes.

AsnReader asn1Seq = new AsnReader(dh\_der\_data, AsnEncodingRules.DER).ReadSequence();

BigInteger dh\_modulus = asn1Seq.ReadInteger();

BigInteger dh\_generator = asn1Seq.ReadInteger();

// Generate our dh\_challenge value by calculating the result of our generator to the power of our random value, modular divided by our dh\_modulus.

BigInteger dh\_challenge = BigInteger.ModPow(dh\_generator, dh\_random, dh\_modulus);

// Extract our dh\_modulus and dh\_generator values from our dhparam.pem file's bytes. AsnReader asn1Seq = new AsnReader(dh\_der\_data, AsnEncodingRules.DER).ReadSequence(); BigInteger dh\_modulus = asn1Seq.ReadInteger(); BigInteger dh\_generator = asn1Seq.ReadInteger(); // Generate our dh\_challenge value by calculating the result of our generator to the power of our random value, modular divided by our dh\_modulus. BigInteger dh\_challenge = BigInteger.ModPow(dh\_generator, dh\_random, dh\_modulus);
...
with open("./private\_encrpytion.pem", "r") as f:

encryption\_key = RSA.importKey(f.read())

bytes\_decrypted\_secret = PKCS1\_v1\_5\_Cipher.new(

key=encryption\_key

).decrypt(

ciphertext=base64.b64decode(access\_token\_secret),

sentinel=None,

)

prepend = bytes\_decrypted\_secret.hex()

\# Replace with path to private encryption key file. with open("./private\_encrpytion.pem", "r") as f: encryption\_key = RSA.importKey(f.read()) bytes\_decrypted\_secret = PKCS1\_v1\_5\_Cipher.new( key=encryption\_key ).decrypt( ciphertext=base64.b64decode(access\_token\_secret), sentinel=None, ) prepend = bytes\_decrypted\_secret.hex()
...
RSACryptoServiceProvider bytes\_decrypted\_secret = new()
...
StreamReader sr = new("./private\_encryption.pem");
...
PemFields pem\_fields = PemEncoding.Find(reader);

// Convert the pem base 64 string content into a byte array for use in our import

byte\[\] der\_data = Convert.FromBase64String(reader\[pem\_fields.Base64Data\]);

// Import the bytes object as our key

bytes\_decrypted\_secret.ImportPkcs8PrivateKey(der\_data, out \_);

// Encode the access token secret as an ASCII bytes object

byte\[\] encryptedSecret = Convert.FromBase64String(access\_token\_secret);

// Decrypt our secret bytes with the encryption key

byte\[\] raw\_prepend = bytes\_decrypted\_secret.Decrypt(encryptedSecret, RSAEncryptionPadding.Pkcs1);

// Convert our bytestring to a hexadecimal string

string prepend = Convert.ToHexString(raw\_prepend).ToLower();

// Create the crypto provider RSACryptoServiceProvider bytes\_decrypted\_secret = new() { // Utililze a keysize of 2048 rather than the default 7168 KeySize = 2048 }; StreamReader sr = new("./private\_encryption.pem"); string reader = sr.ReadToEnd(); sr.Close(); // Find the pem field content from the StreamReader string PemFields pem\_fields = PemEncoding.Find(reader); // Convert the pem base 64 string content into a byte array for use in our import byte\[\] der\_data = Convert.FromBase64String(reader\[pem\_fields.Base64Data\]); // Import the bytes object as our key bytes\_decrypted\_secret.ImportPkcs8PrivateKey(der\_data, out \_); // Encode the access token secret as an ASCII bytes object byte\[\] encryptedSecret = Convert.FromBase64String(access\_token\_secret); // Decrypt our secret bytes with the encryption key byte\[\] raw\_prepend = bytes\_decrypted\_secret.Decrypt(encryptedSecret, RSAEncryptionPadding.Pkcs1); // Convert our bytestring to a hexadecimal string string prepend = Convert.ToHexString(raw\_prepend).ToLower();
...
"diffie\_hellman\_challenge": "",
...
"oauth\_signature": "czbA1dRKJSBdwn5GYxAJQCmCAqfZ6dyOa%2FgmuY%2F5Lhub64cSeQUzKp8vGrF6afnXhCiIXnHsCTONK7uNbRu2V%2FE%2FziQ57BWfbAEzH98kQdWAlWqqmaxXBzbg%2Fr1AZDRP%2FYWrEggNvJaHjbkWaotcrAWpsfxVLcdc3Sl7kXmbFYN0u20MjLUD7q5yDrJT5TXw9JC2xvFimJj65WxqyICZizQUUrg35KRQKaxytQFdwqf5RS6B65gmoi7gHXZcDu2zDWGhe67bZKV8myd0isIJZBs8a5alGd33n7Y1V7pv5Ux9hFOEHEBzSaE3kn9dqw%2Fp5w%2Fl%2F0xiOQGpXWvPRVA2uA%3D%3D",

"oauth\_timestamp": "1722886871",

"oauth\_nonce": "e8181dd345bcc1a7237df79cd1b59219",

"realm": "test\_realm"

}

{ "diffie\_hellman\_challenge": "", "oauth\_consumer\_key": "TESTCONS", "oauth\_token": "e84c11dc149cb96ee5bb", "oauth\_signature\_method": "RSA-SHA256", "oauth\_signature": "czbA1dRKJSBdwn5GYxAJQCmCAqfZ6dyOa%2FgmuY%2F5Lhub64cSeQUzKp8vGrF6afnXhCiIXnHsCTONK7uNbRu2V%2FE%2FziQ57BWfbAEzH98kQdWAlWqqmaxXBzbg%2Fr1AZDRP%2FYWrEggNvJaHjbkWaotcrAWpsfxVLcdc3Sl7kXmbFYN0u20MjLUD7q5yDrJT5TXw9JC2xvFimJj65WxqyICZizQUUrg35KRQKaxytQFdwqf5RS6B65gmoi7gHXZcDu2zDWGhe67bZKV8myd0isIJZBs8a5alGd33n7Y1V7pv5Ux9hFOEHEBzSaE3kn9dqw%2Fp5w%2Fl%2F0xiOQGpXWvPRVA2uA%3D%3D", "oauth\_timestamp": "1722886871", "oauth\_nonce": "e8181dd345bcc1a7237df79cd1b59219", "realm": "test\_realm" }
...
url = f'https://{baseUrl}/oauth/live\_session\_token'

base\_string = f"{prepend}{method}&{quote\_plus(url)}&{quote(params\_string)}"

encoded\_base\_string = base\_string.encode("utf-8")

params\_string = "&".join(\[f"{k}={v}" for k, v in sorted(oauth\_params.items())\]) method = 'POST' url = f'https://{baseUrl}/oauth/live\_session\_token' base\_string = f"{prepend}{method}&{quote\_plus(url)}&{quote(params\_string)}" encoded\_base\_string = base\_string.encode("utf-8")
...
// Sort our oauth\_params dictionary by key.

Dictionary<string, string\> sorted\_params = oauth\_params.OrderBy(pair =\> pair.Key).ToDictionary(pair =\> pair.Key, pair =\> pair.Value);

// Combine our oauth\_params into a single string for our base\_string.

string params\_string = string.Join("&", sorted\_params.Select(kv =\> $"{kv.Key}\={kv.Value}"));

// Create a base string by combining the prepend, url, and params string.

string base\_string = $"{prepend.ToLower()}POST&{EscapeUriDataStringRfc3986(lst\_url)}&{EscapeUriDataStringRfc3986(params\_string)}";

// Convert our new string to a bytestring

byte\[\] encoded\_base\_string = Encoding.UTF8.GetBytes(base\_string);

// Sort our oauth\_params dictionary by key. Dictionary<string, string> sorted\_params = oauth\_params.OrderBy(pair => pair.Key).ToDictionary(pair => pair.Key, pair => pair.Value); // Combine our oauth\_params into a single string for our base\_string. string params\_string = string.Join("&", sorted\_params.Select(kv => $"{kv.Key}={kv.Value}")); // Create a base string by combining the prepend, url, and params string. string base\_string = $"{prepend.ToLower()}POST&{EscapeUriDataStringRfc3986(lst\_url)}&{EscapeUriDataStringRfc3986(params\_string)}"; // Convert our new string to a bytestring byte\[\] encoded\_base\_string = Encoding.UTF8.GetBytes(base\_string);
...
2.  Next, you will need to create a PKCS1 v1.5 ([Rfc2313](https://datatracker.ietf.org/doc/html/rfc2313)
    ) bytestring signature using your Private Encryption Key as an RSA key to sign our sha256 hash value created in our prior step.
...
4.  Finally, we will need to URI escape our string, again using [Rfc3986](https://datatracker.ietf.org/doc/html/rfc3986)
    , to receive our final oauth\_signature value.
...
\# Generate SHA256 hash of base string bytestring. sha256\_hash = SHA256.new(data=encoded\_base\_string) # Generate bytestring PKCS1v1.5 signature of base string hash. # RSA signing key is private signature key. bytes\_pkcs115\_signature = PKCS1\_v1\_5\_Signature.new( rsa\_key=signature\_key ).sign(msg\_hash=sha256\_hash) # Generate str from base64-encoded bytestring signature. b64\_str\_pkcs115\_signature = base64.b64encode(bytes\_pkcs115\_signature).decode("utf-8") # URL-encode the base64 signature str and add to oauth params dict. oauth\_params\['oauth\_signature'\] = quote\_plus(b64\_str\_pkcs115\_signature)
...
SHA256 sha256\_inst = SHA256.Create();

// Generate SHA256 hash of base string bytestring.

byte\[\] sha256\_hash = sha256\_inst.ComputeHash(encoded\_base\_string);

// Create the crypto provider for our signature

RSACryptoServiceProvider bytes\_pkcs115\_signature = new()
...
StreamReader sr = new(signature\_fp);
...
byte\[\] sig\_der\_data = Convert.FromBase64String(reader\[pem\_fields.Base64Data\]);

// Import the bytes object as our key

bytes\_pkcs115\_signature.ImportPkcs8PrivateKey(sig\_der\_data, out \_);

//Generate the Pkcs115 signature key

RSAPKCS1SignatureFormatter rsaFormatter = new(bytes\_pkcs115\_signature);

rsaFormatter.SetHashAlgorithm("SHA256");

//Receive the bytestring of our signature

byte\[\] signedHash = rsaFormatter.CreateSignature(sha256\_hash);

// Convert the bytestring signature to base64.

string b64\_str\_pkcs115\_signature = Convert.ToBase64String(signedHash);

// URL-encode the base64 signature str and add to oauth params dict.

oauth\_params.Add("oauth\_signature", EscapeUriDataStringRfc3986(b64\_str\_pkcs115\_signature));

// Create a Sha256 Instance SHA256 sha256\_inst = SHA256.Create(); // Generate SHA256 hash of base string bytestring. byte\[\] sha256\_hash = sha256\_inst.ComputeHash(encoded\_base\_string); // Create the crypto provider for our signature RSACryptoServiceProvider bytes\_pkcs115\_signature = new() { // Utililze a keysize of 2048 rather than the default 7168 KeySize = 2048 }; // Use our function to retrieve the object bytes StreamReader sr = new(signature\_fp); string reader = sr.ReadToEnd(); sr.Close(); // Find the pem field content from the StreamReader string PemFields pem\_fields = PemEncoding.Find(reader); // Convert the pem base 64 string content into a byte array for use in our import byte\[\] sig\_der\_data = Convert.FromBase64String(reader\[pem\_fields.Base64Data\]); // Import the bytes object as our key bytes\_pkcs115\_signature.ImportPkcs8PrivateKey(sig\_der\_data, out \_); //Generate the Pkcs115 signature key RSAPKCS1SignatureFormatter rsaFormatter = new(bytes\_pkcs115\_signature); rsaFormatter.SetHashAlgorithm("SHA256"); //Receive the bytestring of our signature byte\[\] signedHash = rsaFormatter.CreateSignature(sha256\_hash); // Convert the bytestring signature to base64. string b64\_str\_pkcs115\_signature = Convert.ToBase64String(signedHash); // URL-encode the base64 signature str and add to oauth params dict. oauth\_params.Add("oauth\_signature", EscapeUriDataStringRfc3986(b64\_str\_pkcs115\_signature));
...
oauth\_params\["realm"\] = "test\_realm"

\# Oauth realm param omitted from signature, added to header afterward. oauth\_params\["realm"\] = "test\_realm"
...
oauth\_params.Add("realm", :"test\_realm");

// Oauth realm param omitted from signature, added to header afterward. oauth\_params.Add("realm", :"test\_realm");
...
oauth\_params\["realm"\] = "limited\_poa"

\# Oauth realm param omitted from signature, added to header afterward. oauth\_params\["realm"\] = "limited\_poa"
...
oauth\_params.Add("realm", :"limited\_poa");

// Oauth realm param omitted from signature, added to header afterward. oauth\_params.Add("realm", :"limited\_poa");
...
\# Assemble oauth params into auth header value as comma-separated str. oauth\_header = "OAuth " + ", ".join(\[f'{k}="{v}"' for k, v in sorted(oauth\_params.items())\]) # Create dict for LST request headers including OAuth Authorization header. headers = {"Authorization": oauth\_header}
...
Dictionary fin\_sorted\_params = oauth\_params.OrderBy(pair =\> pair.Key).ToDictionary(pair =\> pair.Key, pair =\> pair.Value);

// Assemble oauth params into auth header value as comma-separated str.

string oauth\_header = $"OAuth " + string.Join(", ", fin\_sorted\_params.Select(kv =\> $"{kv.Key}\=\\"{kv.Value}\\""));

// Add our Authorization header to our request's header container.

request.Headers.Add("Authorization", oauth\_header);

Dictionary fin\_sorted\_params = oauth\_params.OrderBy(pair => pair.Key).ToDictionary(pair => pair.Key, pair => pair.Value); // Assemble oauth params into auth header value as comma-separated str. string oauth\_header = $"OAuth " + string.Join(", ", fin\_sorted\_params.Select(kv => $"{kv.Key}=\\"{kv.Value}\\"")); // Add our Authorization header to our request's header container. request.Headers.Add("Authorization", oauth\_header);
...
*   Authorization: See our prior [Authorization Header](./cpapi-v1.md#lst-auth-header)
     step.
...
"Authorization":oauth\_header,

"User-Agent":"python/3.11"

}

\# Add User-Agent header, required for all requests. Can have any value. headers = { "Authorization":oauth\_header, "User-Agent":"python/3.11" }
...
// Build out our request headers request.Headers.Add("Authorization", oauth\_header); request.Headers.Add("Accept", "\*/\*"); request.Headers.Add("Accept-Encoding", "gzip,deflate"); request.Headers.Add("Connection", "keep-alive"); request.Headers.Add("Host", "api.ibkr.com"); request.Headers.Add("User-Agent", "csharp/6.0");
...
dh\_random = random.getrandbits(256)

\# Compute the Diffie-Hellman challenge:

\# generator ^ dh\_random % dh\_prime
...
"oauth\_token": access\_token,

"oauth\_signature\_method": "RSA-SHA256",

"diffie\_hellman\_challenge": dh\_challenge,
...
base\_string += f"{method}&{quote\_plus(url)}&{quote(params\_string)}"
...
\# Prepare and send request to /live\_session\_token, print request and response.

lst\_request = requests.post(url=url, headers=headers)

\# Check if request returned 200, proceed to compute LST if true, exit if false.

if not lst\_request.ok:

print(f"ERROR: Request to /live\_session\_token failed. Exiting...")

raise SystemExit(0)

\# Script not exited, proceed to compute LST.

response\_data = lst\_request.json()

dh\_response = response\_data\["diffie\_hellman\_response"\]

lst\_signature = response\_data\["live\_session\_token\_signature"\]

lst\_expiration = response\_data\["live\_session\_token\_expiration"\]

\# Generate a random 256-bit integer. dh\_random = random.getrandbits(256) # Compute the Diffie-Hellman challenge: # generator ^ dh\_random % dh\_prime # Note that IB always uses generator = 2. # Convert result to hex and remove leading 0x chars. dh\_challenge = hex(pow(base=dh\_generator, exp=dh\_random, mod=dh\_prime))\[2:\] # -------------------------------- # Generate LST request signature. # -------------------------------- # Generate the base string prepend for the OAuth signature: # Decrypt the access token secret bytestring using private encryption # key as RSA key and PKCS1v1.5 padding. # Prepend is the resulting bytestring converted to hex str. bytes\_decrypted\_secret = PKCS1\_v1\_5\_Cipher.new( key=encryption\_key ).decrypt( ciphertext=base64.b64decode(access\_token\_secret), sentinel=None, ) prepend = bytes\_decrypted\_secret.hex() # Put prepend at beginning of base string str. base\_string = prepend # Elements of the LST request so far. method = 'POST' url = f'https://{baseUrl}/oauth/live\_session\_token' oauth\_params = { "oauth\_consumer\_key": consumer\_key, "oauth\_nonce": hex(random.getrandbits(128))\[2:\], "oauth\_timestamp": str(int(datetime.now().timestamp())), "oauth\_token": access\_token, "oauth\_signature\_method": "RSA-SHA256", "diffie\_hellman\_challenge": dh\_challenge, } # Combined param key=value pairs must be sorted alphabetically by key # and ampersand-separated. params\_string = "&".join(\[f"{k}={v}" for k, v in sorted(oauth\_params.items())\]) # Base string = method + url + sorted params string, all URL-encoded. base\_string += f"{method}&{quote\_plus(url)}&{quote(params\_string)}" # Convert base string str to bytestring. encoded\_base\_string = base\_string.encode("utf-8") # Generate SHA256 hash of base string bytestring. sha256\_hash = SHA256.new(data=encoded\_base\_string) # Generate bytestring PKCS1v1.5 signature of base string hash. # RSA signing key is private signature key. bytes\_pkcs115\_signature = PKCS1\_v1\_5\_Signature.new( rsa\_key=signature\_key ).sign(msg\_hash=sha256\_hash) # Generate str from base64-encoded bytestring signature. b64\_str\_pkcs115\_signature = base64.b64encode(bytes\_pkcs115\_signature).decode("utf-8") # URL-encode the base64 signature str and add to oauth params dict. oauth\_params\['oauth\_signature'\] = quote\_plus(b64\_str\_pkcs115\_signature) # Oauth realm param omitted from signature, added to header afterward. oauth\_params\["realm"\] = realm # Assemble oauth params into auth header value as comma-separated str. oauth\_header = "OAuth " + ", ".join(\[f'{k}="{v}"' for k, v in sorted(oauth\_params.items())\]) # Create dict for LST request headers including OAuth Authorization header. headers = {"Authorization": oauth\_header} # Add User-Agent header, required for all requests. Can have any value. headers\["User-Agent"\] = "python/3.11" # Prepare and send request to /live\_session\_token, print request and response. lst\_request = requests.post(url=url, headers=headers) # Check if request returned 200, proceed to compute LST if true, exit if false. if not lst\_request.ok: print(f"ERROR: Request to /live\_session\_token failed. Exiting...") raise SystemExit(0) # Script not exited, proceed to compute LST. response\_data = lst\_request.json() dh\_response = response\_data\["diffie\_hellman\_response"\] lst\_signature = response\_data\["live\_session\_token\_signature"\] lst\_expiration = response\_data\["live\_session\_token\_expiration"\]
...
"diffie\_hellman\_response": "62933e{...}d64d6db34d",

"live\_session\_token\_signature": "9bd5922b2b79effef23c6fb03cc715dcdc8d6219",

"live\_session\_token\_expiration": 1700691802316

}

{ "diffie\_hellman\_response": "62933e{...}d64d6db34d", "live\_session\_token\_signature": "9bd5922b2b79effef23c6fb03cc715dcdc8d6219", "live\_session\_token\_expiration": 1700691802316 }
...
From the [Live Session Token Response Object](./cpapi-v1.md#lst-response)
, we only received the Diffie-Hellman response, live session token signature, and live session token expiration values. We now need to use the signature and response values in order to compute our live session token.
...
prepend\_bytes = bytes.fromhex(prepend)

\# Generate bytestring from prepend hex str. prepend\_bytes = bytes.fromhex(prepend)
...
byte\[\] prepend\_bytes = Convert.FromHexString(prepend);

//Generate bytestring from prepend hex str. byte\[\] prepend\_bytes = Convert.FromHexString(prepend);
...
\# K will be used to hash the prepend bytestring (the decrypted access token) to produce the LST. B = int(dh\_response, 16) a = dh\_random p = dh\_prime K = pow(B, a, p)
...
// Validate that our dh\_response value has a leading sign bit, and if it's not there then be sure to add it.

if (dh\_response\[0\] != 0)

{

dh\_response = "0" + dh\_response;

}

// Convert our dh\_response hex string to a biginteger.

BigInteger B = BigInteger.Parse(dh\_response, NumberStyles.HexNumber);

BigInteger a = dh\_random;

BigInteger p = dh\_modulus;

// K will be used to hash the prepend bytestring (the decrypted access token) to produce the LST.

BigInteger K = BigInteger.ModPow(B, a, p);

// Validate that our dh\_response value has a leading sign bit, and if it's not there then be sure to add it. if (dh\_response\[0\] != 0) { dh\_response = "0" + dh\_response; } // Convert our dh\_response hex string to a biginteger. BigInteger B = BigInteger.Parse(dh\_response, NumberStyles.HexNumber); BigInteger a = dh\_random; BigInteger p = dh\_modulus; // K will be used to hash the prepend bytestring (the decrypted access token) to produce the LST. BigInteger K = BigInteger.ModPow(B, a, p);
...
if len(hex\_str\_K) % 2:

print("adding leading 0 for even number of chars")

hex\_str\_K = "0" + hex\_str\_K

\# Generate hex bytestring from hex string K.

hex\_bytes\_K = bytes.fromhex(hex\_str\_K)

\# Prepend a null byte to hex bytestring K if lacking sign bit.

if len(bin(K)\[2:\]) % 8 == 0:

hex\_bytes\_K = bytes(1) + hex\_bytes\_K

\# Generate hex string representation of integer K. hex\_str\_K = hex(K)\[2:\] # If hex string K has odd number of chars, add a leading 0, because all Python hex bytes must contain two hex digits (0x01 not 0x1). if len(hex\_str\_K) % 2: print("adding leading 0 for even number of chars") hex\_str\_K = "0" + hex\_str\_K # Generate hex bytestring from hex string K. hex\_bytes\_K = bytes.fromhex(hex\_str\_K) # Prepend a null byte to hex bytestring K if lacking sign bit. if len(bin(K)\[2:\]) % 8 == 0: hex\_bytes\_K = bytes(1) + hex\_bytes\_K
...
string hex\_str\_k = K.ToString("X").ToLower(); // It must be converted to lowercase values prior to byte conversion.

// If hex string K has odd number of chars, add a leading 0

if (hex\_str\_k.Length % 2 != 0)
...
byte\[\] hex\_bytes\_K = Convert.FromHexString(hex\_str\_k);

// Generate hex string representation of integer K. Be sure to strip the leading sign bit. string hex\_str\_k = K.ToString("X").ToLower(); // It must be converted to lowercase values prior to byte conversion. // If hex string K has odd number of chars, add a leading 0 if (hex\_str\_k.Length % 2 != 0) { // Set the lead byte to 0 for a positive sign bit. hex\_str\_k = "0" + hex\_str\_k; } // Generate hex bytestring from hex string K. byte\[\] hex\_bytes\_K = Convert.FromHexString(hex\_str\_k);
...
computed\_lst = base64.b64encode(bytes\_hmac\_hash\_K).decode("utf-8")

bytes\_hmac\_hash\_K = HMAC.new( key=hex\_bytes\_K, msg=prepend\_bytes, digestmod=SHA1, ).digest() # The computed LST is the base64-encoded HMAC hash of the hex prepend bytestring. Converted here to str. computed\_lst = base64.b64encode(bytes\_hmac\_hash\_K).decode("utf-8")
...
HMACSHA1 bytes\_hmac\_hash\_K = new()

{

// Set the HMAC key to our passed intended\_key byte array
...
byte\[\] K\_hash = bytes\_hmac\_hash\_K.ComputeHash(prepend\_bytes);

// Convert hash to base64 to retrieve the computed live session token.

string computed\_lst = Convert.ToBase64String(K\_hash);

// Create HMAC SHA1 object HMACSHA1 bytes\_hmac\_hash\_K = new() { // Set the HMAC key to our passed intended\_key byte array Key = hex\_bytes\_K }; // Hash the SHA1 bytes of our key against the msg content. byte\[\] K\_hash = bytes\_hmac\_hash\_K.ComputeHash(prepend\_bytes); // Convert hash to base64 to retrieve the computed live session token. string computed\_lst = Convert.ToBase64String(K\_hash);
...
hex\_str\_hmac\_hash\_lst = HMAC.new(

key=base64.b64decode(computed\_lst),

msg=consumer\_key.encode("utf-8"),
...
if hex\_str\_hmac\_hash\_lst == lst\_signature:

live\_session\_token = computed\_lst

print("Live session token computation and validation successful.")

print(f"LST: {live\_session\_token}; expires: {datetime.fromtimestamp(lst\_expiration/1000)}\\n")

else:

print(f"ERROR: LST validation failed.")

\# Generate hex-encoded str HMAC hash of consumer key bytestring. # Hash key is base64-decoded LST bytestring, method is SHA1. hex\_str\_hmac\_hash\_lst = HMAC.new( key=base64.b64decode(computed\_lst), msg=consumer\_key.encode("utf-8"), digestmod=SHA1, ).hexdigest() # If our hex hash of our computed LST matches the LST signature received in response, we are successful. if hex\_str\_hmac\_hash\_lst == lst\_signature: live\_session\_token = computed\_lst print("Live session token computation and validation successful.") print(f"LST: {live\_session\_token}; expires: {datetime.fromtimestamp(lst\_expiration/1000)}\\n") else: print(f"ERROR: LST validation failed.")
...
byte\[\] b64\_decode\_lst = Convert.FromBase64String(computed\_lst);

// Convert our consumer key str to bytes

byte\[\] consumer\_bytes = Encoding.UTF8.GetBytes(consumer\_key);

// Hash the SHA1 bytes against our hex bytes of K.

byte\[\] hashed\_consumer = EasySha1(b64\_decode\_lst, consumer\_bytes);

// Convert hash to base64 to retrieve the computed live session token.

string hex\_lst\_hash = Convert.ToHexString(hashed\_consumer).ToLower();

// If our hex hash of our computed LST matches the LST signature received in response, we are successful.

if (hex\_lst\_hash == lst\_signature)

{

string live\_session\_token = computed\_lst;

Console.WriteLine("Live session token computation and validation successful.");

Console.WriteLine($"LST: {live\_session\_token}; expires: {lst\_expiration}\\n");
...
Console.WriteLine($"Hexed LST: {hex\_lst\_hash} | LST Signature: {lst\_signature}\\n");

}

//Generate hex - encoded str HMAC hash of consumer key bytestring. // Hash key is base64 - decoded LST bytestring, method is SHA1 byte\[\] b64\_decode\_lst = Convert.FromBase64String(computed\_lst); // Convert our consumer key str to bytes byte\[\] consumer\_bytes = Encoding.UTF8.GetBytes(consumer\_key); // Hash the SHA1 bytes against our hex bytes of K. byte\[\] hashed\_consumer = EasySha1(b64\_decode\_lst, consumer\_bytes); // Convert hash to base64 to retrieve the computed live session token. string hex\_lst\_hash = Convert.ToHexString(hashed\_consumer).ToLower(); // If our hex hash of our computed LST matches the LST signature received in response, we are successful. if (hex\_lst\_hash == lst\_signature) { string live\_session\_token = computed\_lst; Console.WriteLine("Live session token computation and validation successful."); Console.WriteLine($"LST: {live\_session\_token}; expires: {lst\_expiration}\\n"); } else { Console.WriteLine("######## LST MISMATCH! ########"); Console.WriteLine($"Hexed LST: {hex\_lst\_hash} | LST Signature: {lst\_signature}\\n"); }
...
*   Third Party OAuth: This is received from the [Access Token endpoint](./cpapi-v1.md#access-token)
...
"oauth\_signature\_method": "HMAC-SHA256",
...
oauth\_params = { "oauth\_consumer\_key": consumer\_key, "oauth\_nonce": hex(random.getrandbits(128))\[2:\], "oauth\_signature\_method": "HMAC-SHA256", "oauth\_timestamp": str(int(datetime.now().timestamp())), "oauth\_token": access\_token }
...
String oauth\_nonce = random.Next(1, int.MaxValue).ToString("X").ToLower();

//Create a dictionary for all oauth params in our header.

Dictionary<string, string\> oauth\_params = new()

{

{ "oauth\_consumer\_key", consumer\_key },

{ "oauth\_nonce", oauth\_nonce },
...
// Interactive Brokers requires a 10 digit Unix timestamp value. // Values beyond 10 digits will result in an error. string timestamp = DateTimeOffset.Now.ToUnixTimeMilliseconds().ToString(); timestamp = timestamp.Substring(0, timestamp.Length - 3); // Create a Random object, and then retrieve any random positive integer value. Random random = new(); String oauth\_nonce = random.Next(1, int.MaxValue).ToString("X").ToLower(); //Create a dictionary for all oauth params in our header. Dictionary<string, string> oauth\_params = new() { { "oauth\_consumer\_key", consumer\_key }, { "oauth\_nonce", oauth\_nonce }, { "oauth\_timestamp", timestamp }, { "oauth\_token", access\_token }, { "oauth\_signature\_method", "HMAC-SHA256" } };
...
params\_string = "&".join(\[f"{k}={v}" for k, v in sorted(oauth\_params.items())\]) method = 'POST' url = f'https://{baseUrl}/oauth/live\_session\_token' base\_string = f"{method}&{quote\_plus(url)}&{quote(params\_string)}" encoded\_base\_string = base\_string.encode("utf-8")
...
string base\_string = $"POST&{EscapeUriDataStringRfc3986(lst\_url)}&{EscapeUriDataStringRfc3986(params\_string)}";

// Convert our new string to a bytestring

byte\[\] encoded\_base\_string = Encoding.UTF8.GetBytes(base\_string);

// Sort our oauth\_params dictionary by key. Dictionary<string, string> sorted\_params = oauth\_params.OrderBy(pair => pair.Key).ToDictionary(pair => pair.Key, pair => pair.Value); // Combine our oauth\_params into a single string for our base\_string. string params\_string = string.Join("&", sorted\_params.Select(kv => $"{kv.Key}={kv.Value}")); // Create a base string by combining the prepend, url, and params string. string base\_string = $"POST&{EscapeUriDataStringRfc3986(lst\_url)}&{EscapeUriDataStringRfc3986(params\_string)}"; // Convert our new string to a bytestring byte\[\] encoded\_base\_string = Encoding.UTF8.GetBytes(base\_string);
...
4.  Then URI escape our string, again using [Rfc3986](https://datatracker.ietf.org/doc/html/rfc3986)
    , to receive our final oauth\_signature value.
...
bytes\_hmac\_hash = HMAC.new(

key=base64.b64decode(live\_session\_token),

msg=base\_string.encode("utf-8"),
...
b64\_str\_hmac\_hash = base64.b64encode(bytes\_hmac\_hash).decode("utf-8")

\# URL-encode the base64 hash str and add to oauth params dict.

oauth\_params\["oauth\_signature"\] = quote\_plus(b64\_str\_hmac\_hash)

\# Generate bytestring HMAC hash of base string bytestring. # Hash key is base64-decoded LST bytestring, method is SHA256. bytes\_hmac\_hash = HMAC.new( key=base64.b64decode(live\_session\_token), msg=base\_string.encode("utf-8"), digestmod=SHA256 ).digest() # Generate str from base64-encoded bytestring hash. b64\_str\_hmac\_hash = base64.b64encode(bytes\_hmac\_hash).decode("utf-8") # URL-encode the base64 hash str and add to oauth params dict. oauth\_params\["oauth\_signature"\] = quote\_plus(b64\_str\_hmac\_hash)
...
HMACSHA256 bytes\_hmac\_hash\_K = new()

{

// Set the HMAC key to our live\_session\_token

Key = Convert.FromBase64String(computed\_lst)

};

// Hash the SHA256 bytes against our encoded bytes.

byte\[\] K\_hash = bytes\_hmac\_hash\_K.ComputeHash(encoded\_base\_string);

// Generate str from base64-encoded bytestring hash.

string b64\_str\_hmac\_hash = Convert.ToBase64String(K\_hash);

// URL-encode the base64 hash str and add to oauth params dict.

oauth\_params.Add("oauth\_signature", EscapeUriDataStringRfc3986(b64\_str\_hmac\_hash));

// Create HMAC SHA256 object HMACSHA256 bytes\_hmac\_hash\_K = new() { // Set the HMAC key to our live\_session\_token Key = Convert.FromBase64String(computed\_lst) }; // Hash the SHA256 bytes against our encoded bytes. byte\[\] K\_hash = bytes\_hmac\_hash\_K.ComputeHash(encoded\_base\_string); // Generate str from base64-encoded bytestring hash. string b64\_str\_hmac\_hash = Convert.ToBase64String(K\_hash); // URL-encode the base64 hash str and add to oauth params dict. oauth\_params.Add("oauth\_signature", EscapeUriDataStringRfc3986(b64\_str\_hmac\_hash));
...
*   Accept: This must be set to “\*/\*”
*   Accept-Encoding: This must be set to “gzip,deflate”
*   Authorization: See our prior [Authorization Header](./cpapi-v1.md#standard-auth-header)
     step.
*   Connection: This must be set to “keep-alive”.
*   Host: This must be set to “api.ibkr.com”
*   User-Agent: This may be anything, though the browser identifier or request language is suggested.
...
After calculating our Authorization header creating our headers, we can submit the request. As mentioned in our [Endpoints section](./cpapi-v1.md#endpoints)
, all content would then be submitted as JSON formatting. Examples in the respective languages have been included for our example.
...
json\_data = {"publish":True, "compete":True}

\# end request to /ssodh/init, print request and response.

init\_request = requests.post(url=url, headers=headers, json=json\_data)

if init\_request.status\_code == 200:

print(init\_request.content)

json\_data = {"publish":True, "compete":True} # end request to /ssodh/init, print request and response. init\_request = requests.post(url=url, headers=headers, json=json\_data) if init\_request.status\_code == 200: print(init\_request.content)
...
string req\_content = JsonSerializer.Serialize(new { compete = true, publish = true });

StringContent req\_content\_json = new(req\_content, Encoding.UTF8, "application/json");

request.Content = req\_content\_json;

HttpResponseMessage response = client.SendAsync(request).Result;

string req\_content = JsonSerializer.Serialize(new { compete = true, publish = true }); StringContent req\_content\_json = new(req\_content, Encoding.UTF8, "application/json"); request.Content = req\_content\_json; HttpResponseMessage response = client.SendAsync(request).Result;
...
![The Flex Query page of the Client Portal.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/flex_queries-700x273.png)
...
![The Configure Flex Web Service page after generating a new token.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/configure_flex_web_service-700x324.png)
...
![The Token Generation section for the Configure Flex Web Service page.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/new_flex_token-700x316.png)
...
![Highlighting the Activity Flex Query and Trade Confirmation Flex Query sections of the Flex Queries page.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/generate_flex_query-700x273.png)

Next, click on the **Info** icon to the left of a Flex Query.

![Highlighting the Information button for a Flex Query.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/find_query_id-700x290.png)

From the info pop-over, capture the **Query ID** number listed at the top. This will be used when generating your report.

![Highlight of the Query ID for a specific Flex Query.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/query_id-700x349.png)
...
![include Audit Trail Fields](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/includeAuditTrailFields.png)
...
flexReq = requests.get(url=requestBase+send\_slug, params=send\_params)

requestBase = "https://ndcdyn.interactivebrokers.com/AccountManagement/FlexWebService" token = 528191644107458877539776 queryId = 800969 flex\_version = 3 send\_path = "/SendRequest" send\_params = { "t":token, "q":queryId, "v":flex\_version } flexReq = requests.get(url=requestBase+send\_slug, params=send\_params)
...
**ErrorCode**.  
A numeric code indicating the nature of the failure. See [Error Codes](./cpapi-v1.md#error-codes)
 for a list of error code values and their descriptions.

**ErrorMessage**.  
A human-readable description of the error. See [Error Codes](./cpapi-v1.md#error-codes)
 for a list of error code values and their descriptions.
...
receiveUrl = requests.get(url=requestBase+receive\_slug, params=receive\_params, allow\_redirects=True)

open(csvPath, 'wb').write(receiveUrl.content)

tree = ET.ElementTree(ET.fromstring(flexReq.text)) root = tree.getroot() for child in root: if child.tag == "Status": if child.text != "Success": print(f"Failed to generate Flex statement. Stopping...") exit() elif child.tag == "ReferenceCode": refCode = child.text print("Hold for Request.") time.sleep(20) receive\_slug = "/GetStatement" receive\_params = { "t":token, "q":refCode, "v":flex\_version } receiveUrl = requests.get(url=requestBase+receive\_slug, params=receive\_params, allow\_redirects=True) open(csvPath, 'wb').write(receiveUrl.content)
...
| 1018 | Too many requests have been made from this token. Please try again shortly.  <br>Limited to one request per second, 10 requests per minute (per token). |

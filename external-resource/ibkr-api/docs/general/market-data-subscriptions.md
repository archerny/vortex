...
*   [Introduction](./market-data-subscriptions.md#introduction)
    
*   [Market Data Requirements](./market-data-subscriptions.md#market-data-requirements)
    
*   [Market Data Subscription Minimum Equity Balance Requirements](./market-data-subscriptions.md#minimum-account-balance)
    
*   [Support for Market Data Subscriptions](./market-data-subscriptions.md#md-support)
    
*   [Compliance Requirements for API Market Data](./market-data-subscriptions.md#md-compliance)
    *   [Market Data API Acknowledgement](./market-data-subscriptions.md#md-api-ack)
        
    *   [API User Activity Certification](./market-data-subscriptions.md#md-ats)
        *   [Automation and Software Disclosure](./market-data-subscriptions.md#md-ats-disclosure)
            
*   [Professional vs Non-Professional](./market-data-subscriptions.md#pro-vs-non-pro)
    
*   [Market Data & Users](./market-data-subscriptions.md#md-users)
    *   [Multiple Users](./market-data-subscriptions.md#mutli-user)
        
    *   [Market Data Sharing](./market-data-subscriptions.md#md-share)
        
    *   [Finding your Paper User Credentials](./market-data-subscriptions.md#paper-info)
        *   [Step One: Log In To Client Portal](./market-data-subscriptions.md#paper-step-one)
            
        *   [Step Two: Click the Head & Shoulders Icon](./market-data-subscriptions.md#paper-step-two)
            
        *   [Step Three: Go to the Settings Page](./market-data-subscriptions.md#paper-step-three)
            
        *   [Step Four: Open the Paper Trading Account settings](./market-data-subscriptions.md#paper-step-four)
            
        *   [Step Five: Review Your Paper Credentials](./market-data-subscriptions.md#paper-step-five)
            
*   [TWS Data vs API Data](./market-data-subscriptions.md#tws-vs-api)
    
*   [Market Data Costs and Fees](./market-data-subscriptions.md#costs-and-fees)
    
*   [Market Data Lines](./market-data-subscriptions.md#market-data-lines)
    *   [Specialized Market Data Lines](./market-data-subscriptions.md#quote-max)
        
    *   [How Market Data is Allocated](./market-data-subscriptions.md#md-line-allocations)
        
*   [Understanding Market Data Subscriptions](./market-data-subscriptions.md#understanding-market-data)
    
*   [Regulatory Snapshots](./market-data-subscriptions.md#reg-snapshot)
    
*   [Popular Market Data Subscriptions](./market-data-subscriptions.md#popular-md-subscriptions)
    *   [Chinese Market Data Subscriptions](./market-data-subscriptions.md#chinese-md-subscriptions)
        
    *   [News Data](./market-data-subscriptions.md#news-subscriptions)
        
*   [NASDAQ Specialty Subscriptions](./market-data-subscriptions.md#nasdaq-l2-data)
...
![Client Portal market data subscriptions settings highlighting the location of the Market Data API Acknowledgement.](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/screenshot.jpg)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/screenshot-700x219.jpg)
...
This will also effect those that use [Third Party software](../third-party/third-party-connections.md)
.

If you are not prompted through the notification bell after logging in to [Client Portal](https://interactivebrokers.com/)
, you can find the Market Data API Acknowledgement by:
...
![Display the Market Data API Acknowledgement with an Enabled status within Client Portal.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/md-ack-700x597.png)
...
![Displays the API User Activity Certification initial prompt.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/ats-prompt.png)
...
3.  All or some of the API messages submitted are manually approved (e.g by clicking a button) (You do not need to check this box if you only use TWS for manual orders. Check this box if you use a third party front end).

*   This option is for users who are using a [Third Party Software provider](../third-party/third-party-connections.md)
     to manually submit your order.

5.  All or Some of the API messages submitted are generated & submitted by an automated system.
...
![The Automation and Software Disclosure window that within the API Usage Information certification.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/ats-disclosure.png)
...
Market data may also be shared between a live and paper username so that both can retrieve data using the same market data subscription. Each Live user can share data with one (1) Paper account, with one Paper account allowed per live account. Please see our [Market Data Considerations](https://www.ibkrguides.com/kb/article-1719.htm)
 page for additional insight into the behavior of shared market data.
...
Log in to the [Client Portal](https://ndcdyn.interactivebrokers.com/sso/Login)
 using your Live Account’s username and password.

![Client Portal login window.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/liveLogin-700x584.png)
...
![Highlight for the Welcome window in the Client Portal](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/h_s.png)
...
![Additional highlight of the activated Head & Shoulders window for the Settings section.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/settingsDropDown-700x178.png)
...
![Client Portal Account Settings page highlighting the Paper Trading Account link.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/PaperAccountConfig-700x472.png)
...
![Highlihgt for the Paper Trading Username within the Paper Trading Account settings page.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/paperDetails-700x391.png)
...
**Windows/ Unix/ Linux:** Click “_Ctrl_” + “_Alt_” + “_\=_”

**MacOS:** Click “_CMD_” + “_OPT_” + “_+_”
...
![An example of the Market Data Lines window in Trader Workstation](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/market-data-lines-display.png)
...
[Market Data Assistant](https://www.interactivebrokers.com/lib/cstools/faq/#/content/28215165)
 [Market Data Pricing](https://www.interactivebrokers.com/en/pricing/market-data-pricing.php?p=mktDataPricing)

While this list contains some of the more common market data subscriptions, this does not indicate trading advice, nor the best subscription for every individual. If you have any questions about specific market data subscriptions, please [create a ticket](./market-data-subscriptions.md#md-support)
...
![Displays the TWS API News Configuration window.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/%E6%93%B7%E5%8F%96-3-700x491.png)
...
![Displays the Benzinga Breaking News via API market data subscription in Client Portal.](<Base64-Image-Removed>)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/%E6%93%B7%E5%8F%96-4-700x319.png)

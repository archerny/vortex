...
[](./quote-cc-cpp.md#get_symbols-%E8%8E%B7%E5%8F%96%E6%89%80%E6%9C%89%E4%BB%A3%E7%A0%81%E5%88%97%E8%A1%A8)
...
| 参数名 | 类型  | 是否必填 | 描述  |
| --- | --- | --- | --- |
| sec\_type | utility::string\_t | Yes | 固定为 U("CC") |
...
[](./quote-cc-cpp.md#get_cc_briefs-%E8%8E%B7%E5%8F%96%E5%AE%9E%E6%97%B6%E8%A1%8C%E6%83%85)
...
| sec\_type | utility::string\_t | Yes | 固定为 U("CC") |
| lang | utility::string\_t | No  | 支持的语言，如 U("zh\_CN")，默认英文 |
...
[](./quote-cc-cpp.md#get_bars-%E8%8E%B7%E5%8F%96k%E7%BA%BF%E6%95%B0%E6%8D%AE)
...
| period | BarPeriod 或 utility::string\_t | No  | 获取的K线周期。默认 BarPeriod::DAY，可选值：day/week/month/year/1min/3min/5min/10min/15min/30min/60min |
| begin\_time | time\_t | No  | 区间查询的开始时间，建议使用时间戳，避免不同市场的时区问题，默认 -1 |
| end\_time | time\_t | No  | 区间查询的截止时间，默认 -1 |
...
[](./quote-cc-cpp.md#get_timeline-%E8%8E%B7%E5%8F%96%E6%9C%80%E8%BF%91%E4%B8%80%E4%B8%AA%E4%BA%A4%E6%98%93%E6%97%A5%E7%9A%84%E5%88%86%E6%97%B6%E6%95%B0%E6%8D%AE)
...
| begin\_time | time\_t | No  | 获取分时数据的起始时间，支持毫秒级别的时间戳，如 1639386000000，**默认返回当天数据**，默认 -1 |

...
*   **返回**
    ...
    *   K 线数据格式如下：
        ...
        | k\_type | [KLType](./quote_quote.md#4119) | K 线类型 |
...
*   此接口提供了持续获取推送数据的功能，如需一次性获取实时数据，请参考 [获取实时 K 线](./quote_get-kl.md)
     接口
...
← [实时摆盘回调](./quote_update-order-book.md) [实时分时回调](./quote_update-rt.md)
 →

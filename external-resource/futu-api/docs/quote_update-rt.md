...
*   [简体中文](https://openapi.futunn.com/futu-api-doc/quote/update-rt.html)
    
*   [English](https://openapi.futunn.com/futu-api-doc/en/quote/update-rt.html)
    
*   [繁體中文](https://openapi.futunn.com/futu-api-doc/hk/quote/update-rt.html)
...
[#](https://openapi.futunn.com/futu-api-doc/quote/update-rt.html#6549)
 实时分时回调
==============================================================================
...
*   **介绍**
    ...
    在收到实时分时数据推送后会回调到该函数，您需要在派生类中覆盖 on\_recv\_rsp。
    
*   **参数**
    
    | 参数  | 类型  | 说明  |
    | --- | --- | --- |
    | rsp\_pb | Qot\_UpdateRT\_pb2.Response | 派生类中不需要直接处理该参数 |
...
*   **返回**
    ...
    *   分时数据格式如下：
        ...
        | avg\_price | float | 平均价格<br><br>![](https://openapi.futunn.com/futu-api-doc/img/tip.png)<br><br>对于期权，该字段为 None |
        | volume | float | 成交量 |
        | turnover | float | 成交金额 |
...
[#](https://openapi.futunn.com/futu-api-doc/quote/update-rt.html#7747)
 Qot\_UpdateRT.proto
-------------------------------------------------------------------------------------------
...
*   **参数**
    ...
    message S2C
    {
    	...
    	repeated Qot_Common.TimeShare rtList = 2; //推送的分时数据结构体
    }
...
*   **Output**
    ...
    OnPush_UpdateRT: 
    {
     ...
     "s2c": {
      ...
      "rtList": [\
       {\
        "time": "2021-06-09 11:13:00",\
        "minute": 673,\
        "isBlank": false,\
        "price": 605,\
        "lastClosePrice": 601,\
        "avgPrice": 602.08605915512078,\
        "volume": "1000",\
        "turnover": 605375,\
...
*   **Example**
    ...
    function QotUpdateRT(){
        ...
        websocket.onPush = (cmd, res)=>{
            if(ftCmdID.QotUpdateRT.cmd == cmd){ // 实时分时推送的处理逻辑
                let { retType, s2c } = res
...
*   此接口提供了持续获取推送数据的功能，如需一次性获取实时数据，请参考 [获取实时分时](https://openapi.futunn.com/futu-api-doc/quote/get-rt.html)
     接口
...
[#](https://openapi.futunn.com/futu-api-doc/quote/update-rt.html#7747-2)
 Qot\_UpdateRT.proto
---------------------------------------------------------------------------------------------
...
← [实时 K 线回调](https://openapi.futunn.com/futu-api-doc/quote/update-kl.html) [实时逐笔回调](https://openapi.futunn.com/futu-api-doc/quote/update-ticker.html)
 →

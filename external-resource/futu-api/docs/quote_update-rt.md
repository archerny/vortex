...
*   此接口提供了持续获取推送数据的功能，如需一次性获取实时数据，请参考 [获取实时分时](./quote_get-rt.md)
     接口
...
← [实时 K 线回调](./quote_update-kl.md) [实时逐笔回调](./quote_update-ticker.md)
 →

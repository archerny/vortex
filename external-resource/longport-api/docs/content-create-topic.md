...
|     |     |
| --- | --- |
| Python | [longbridge.openapi.ContentContext.create\_topic](https://longbridge.github.io/openapi/python/reference_all/#longbridge.openapi.ContentContext.create_topic) |
| Rust | [longbridge::content::ContentContext#create\_topic](https://longbridge.github.io/openapi/rust/longbridge/content/struct.ContentContext.html#method.create_topic) |
| Go  | [ContentContext.CreateTopic](https://pkg.go.dev/github.com/longbridge/openapi-go/content#ContentContext.CreateTopic) |
| Node.js | [ContentContext#createTopic](https://longbridge.github.io/openapi/nodejs/classes/ContentContext.html#createtopic) |
| Java | [ContentContext.getCreateTopic](https://longbridge.github.io/openapi/java/com/longbridge/content/ContentContext.html#getCreateTopic) |
| C++ | [longbridge::content::ContentContext::create\_topic](https://longbridge.github.io/openapi/cpp/classlongbridge_1_1content_1_1_content_context.html) |

Request [​](./content-create-topic.md#request)
...
### Request Body [​](./content-create-topic.md#request-body)
...
| topic\_type | string | NO  | 内容类型：`post`（纯文本，默认）或 `article`（Markdown） |
...
### Request Example [​](./content-create-topic.md#request-example)
...
Response [​](./content-create-topic.md#response)

-----------------------------------------------------------------------------------

### Response Headers [​](./content-create-topic.md#response-headers)

*   Content-Type: application/json

### Response Example [​](./content-create-topic.md#response-example)
...
### Response Status [​](./content-create-topic.md#response-status)

| Status | Description | Schema |
| --- | --- | --- |
| 200 | 返回成功 | [create\_topic\_response](./content-create-topic.md#schemacreate-topic-response) |
| 403 | 权限不足 | 用户未开户或无资产 |
| 429 | 频率超限 | 超过每分钟或每日创建上限，请稍后重试 |
| 500 | 内部错误 | None |

Schemas [​](./content-create-topic.md#schemas)

---------------------------------------------------------------------------------

### create\_topic\_response [​](./content-create-topic.md#create-topic-response)
...
| ∟ topic\_type | string | false | 内容类型，`article` 或 `post` |
...
| ∟ detail\_url | string | false | 讨论页面直链 |
...
| ∟ updated\_at | string | false | 最近更新时间，Unix 时间戳（秒） |

[LLMs Text](https://open.longbridge.com/docs/content/create-topic.md)

[Edit this page](https://github.com/longbridge/developers/edit/main/docs/zh-CN/docs/content/create_topic.md)

最后更新于:

Pager

[上一页获取我发布的讨论](./content-my-topics.md)

[下一页获取讨论详情](./content-topic-detail.md)

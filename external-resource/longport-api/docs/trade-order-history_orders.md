...
|     |     |
| --- | --- |
| Python | [longbridge.openapi.TradeContext.history\_orders](https://longbridge.github.io/openapi/python/reference_all/#longbridge.openapi.TradeContext.history_orders) |
| Rust | [longbridge::trade::TradeContext#history\_orders](https://longbridge.github.io/openapi/rust/longbridge/trade/struct.TradeContext.html#method.history_orders) |
| Go  | [TradeContext.HistoryOrders](https://pkg.go.dev/github.com/longbridge/openapi-go/trade#TradeContext.HistoryOrders) |
| Node.js | [TradeContext#historyOrders](https://longbridge.github.io/openapi/nodejs/classes/TradeContext.html#historyorders) |
| Java | [TradeContext.getHistoryOrders](https://longbridge.github.io/openapi/java/com/longbridge/trade/TradeContext.html#getHistoryOrders(com.longbridge.trade.GetHistoryOrdersOptions)) |
| C++ | [longbridge::trade::TradeContext::history\_orders](https://longbridge.github.io/openapi/cpp/classlongbridge_1_1trade_1_1_trade_context.html#a042c94acf87d282f7c106a44efeedbbd) |

Request [​](./trade-order-history_orders.md#request)
...
### Parameters [​](./trade-order-history_orders.md#parameters)
...
### Request Example [​](./trade-order-history_orders.md#request-example)
...
Response [​](./trade-order-history_orders.md#response)

-----------------------------------------------------------------------------------------

### Response Headers [​](./trade-order-history_orders.md#response-headers)

*   Content-Type: application/json

### Response Example [​](./trade-order-history_orders.md#response-example)
...
### Response Status [​](./trade-order-history_orders.md#response-status)

| Status | Description | Schema |
| --- | --- | --- |
| 200 | 历史订单查询成功 | [history\_orders\_rsp](./trade-order-history_orders.md#schemahistory-orders-rsp) |
| 400 | 查询失败，请求参数错误。 | None |

Schemas [​](./trade-order-history_orders.md#schemas)

---------------------------------------------------------------------------------------

### history\_orders\_rsp [​](./trade-order-history_orders.md#history-orders-rsp)
...
[LLMs Text](https://open.longbridge.com/docs/trade/order/history_orders.md)

[Edit this page](https://github.com/longbridge/developers/edit/main/docs/zh-CN/docs/trade/order/history_orders.md)

最后更新于:

Pager

[上一页预估最大购买数量](./trade-order-estimate_available_buy_limit.md)

[下一页订单详情](./trade-order-order_detail.md)
